...
public class RackServiceImpl extends SuperService<Rack> implements IRackService {
	 ...
	 */
	@Override
	public Result insert(Rack rack,boolean throwsException) {
		Result r=super.insert(rack,throwsException);
		return r;
	}
	...
	public Result update(Rack rack , SaveMode mode) {
		return this.update(rack,mode,true);
	}
	 ...
	 * */
	@Override
	public Result update(Rack rack , SaveMode mode,boolean throwsException) {
		Result r=super.update(rack , mode , throwsException);
		return r;
	}
	 ...
	 * @return 判断结果
	 */
	public Boolean checkExists(Rack rack) {
		//TDOD 此处添加判断段的代码
		//boolean exists=super.checkExists(rack, SYS_ROLE.NAME);
		//return exists;
		return false;
	}
