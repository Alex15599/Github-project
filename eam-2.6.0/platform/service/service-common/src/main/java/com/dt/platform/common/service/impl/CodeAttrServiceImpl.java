...
public class CodeAttrServiceImpl extends SuperService<CodeAttr> implements ICodeAttrService {
	 ...
	 */
	@Override
	public Result insert(CodeAttr codeAttr,boolean throwsException) {
		Result r=super.insert(codeAttr,throwsException);
		return r;
	}
	...
	public Result insert(CodeAttr codeAttr) {
		return this.insert(codeAttr,true);
	}
	...
	public Result update(CodeAttr codeAttr , SaveMode mode) {
		return this.update(codeAttr,mode,true);
	}
	 ...
	 * */
	@Override
	public Result update(CodeAttr codeAttr , SaveMode mode,boolean throwsException) {
		Result r=super.update(codeAttr , mode , throwsException);
		return r;
	}
	...
	@Override
	public List<CodeAttr> queryListByIds(List<String> ids) {
		return super.queryListByUKeys("id",ids);
	}

	@Override
	public Map<String, CodeAttr> queryMapByIds(List<String> ids) {
		return super.queryMapByUKeys("id",ids, CodeAttr::getId);
	}
	 ...
	 * */
	@Override
	public List<CodeAttr> queryList(CodeAttrVO sample) {
	 ...
	 * */
	@Override
	public PagedList<CodeAttr> queryPagedList(CodeAttrVO sample, int pageSize, int pageIndex) {
	 ...
	 * @return 判断结果
	 */
	public Boolean checkExists(CodeAttr codeAttr) {
		//TDOD 此处添加判断段的代码
		//boolean exists=super.checkExists(codeAttr, SYS_ROLE.NAME);
		//return exists;
		return false;
	}
