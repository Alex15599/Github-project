...
public interface ICodeAttrService extends  ISimpleIdService<CodeAttr,String> {
	 ...
	 * @return 插入是否成功
	 * */
	Result insertList(List<CodeAttr> codeAttrList);
	 ...
	 * @return 保存是否成功
	 * */
	Result save(CodeAttr codeAttr , SaveMode mode);
	 ...
	 * @return 是否已经存在
	 * */
	boolean checkExists(CodeAttr codeAttr,DBField... field);
	 ...
	 * */
	ConditionExpr buildQueryCondition(CodeAttr sample);
	 ...
	 * 	@return ConditionExpr 条件表达式
	 * */
	ConditionExpr buildQueryCondition(CodeAttr sample,String tableAliase);
	 ...
	 * @return 查询结果
	 * */
	List<CodeAttr> queryList(CodeAttr sample,ConditionExpr condition,OrderBy orderBy);
	 ...
	 * @return 查询结果
	 * */
	List<CodeAttr> queryList(CodeAttr sample,OrderBy orderBy);
	 ...
	 * @return 查询结果
	 * */
	List<CodeAttr> queryList(CodeAttr sample,ConditionExpr condition);
	 ...
	 * @return 查询结果
	 * */
	CodeAttr queryEntity(CodeAttr sample);
	 ...
	 * @return 查询结果
	 * */
	PagedList<CodeAttr> queryPagedList(CodeAttr sample,ConditionExpr condition,OrderBy orderBy,int pageSize,int pageIndex);
	 ...
	 * @return 查询结果
	 * */
	PagedList<CodeAttr> queryPagedList(CodeAttr sample,ConditionExpr condition,int pageSize,int pageIndex);
	 ...
	 * @return 查询结果
	 * */
	PagedList<CodeAttr> queryPagedList(CodeAttr sample,OrderBy orderBy,int pageSize,int pageIndex);
