...
public class SupplierServiceImpl extends SuperService<Supplier> implements ISupplierService {
	 ...
	 */
	@Override
	public Result insert(Supplier supplier,boolean throwsException) {
		Result r=super.insert(supplier,throwsException);
		return r;
	}
	...
	public Result insert(Supplier supplier) {
		return this.insert(supplier,true);
	}
	...
	public Result update(Supplier supplier , SaveMode mode) {
		return this.update(supplier,mode,true);
	}
	 ...
	 * */
	@Override
	public Result update(Supplier supplier , SaveMode mode,boolean throwsException) {
		Result r=super.update(supplier , mode , throwsException);
		return r;
	}
