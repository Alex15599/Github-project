...
public class WarehouseServiceImpl extends SuperService<Warehouse> implements IWarehouseService {
	 ...
	 */
	@Override
	public Result insert(Warehouse warehouse,boolean throwsException) {
		Result r=super.insert(warehouse,throwsException);
		return r;
	}
	...
	public Result insert(Warehouse warehouse) {
		return this.insert(warehouse,true);
	}
	...
	public Result update(Warehouse warehouse , SaveMode mode) {
		return this.update(warehouse,mode,true);
	}
	 ...
	 * @return 判断结果
	 */
	public Boolean checkExists(Warehouse warehouse) {
		//TDOD 此处添加判断段的代码
		//boolean exists=super.checkExists(warehouse, SYS_ROLE.NAME);
		//return exists;
		return false;
	}
