...
public class AssetLabelPaperServiceImpl extends SuperService<AssetLabelPaper> implements IAssetLabelPaperService {
	...
	public Result deleteByIdLogical(String id) {
		...
		if(id==null) return ErrorDesc.failure().message("id 不允许为 null 。");
		assetLabelPaper.setId(id);
		assetLabelPaper.setDeleted(true);
	 ...
	 * */
	@Override
	public List<AssetLabelPaper> getByIds(List<String> ids) {
	 ...
	 * */
	@Override
	public List<AssetLabelPaper> queryList(AssetLabelPaperVO sample) {
	 ...
	 * */
	@Override
	public PagedList<AssetLabelPaper> queryPagedList(AssetLabelPaperVO sample, int pageSize, int pageIndex) {
