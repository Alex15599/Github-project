...
public interface IManufacturerService extends  ISimpleIdService<Manufacturer,String> {
	 ...
	 */
	Result insert(Manufacturer manufacturer,boolean throwsException);
	 ...
	 * @return 插入是否成功
	 * */
	Result insertList(List<Manufacturer> manufacturerList);
	 ...
	 * @return 保存是否成功
	 * */
	Result update(Manufacturer manufacturer , SaveMode mode);
	 ...
	 * @return 结果
	 */
	Result update(Manufacturer manufacturer , SaveMode mode,boolean throwsException);
	 ...
	 * @return 保存是否成功
	 * */
	Result updateList(List<Manufacturer> manufacturerList, SaveMode mode);
	 ...
	 * @return 保存是否成功
	 * */
	Result save(Manufacturer manufacturer , SaveMode mode,boolean throwsException);
	 ...
	 * @return 保存是否成功
	 * */
	Result save(Manufacturer manufacturer , SaveMode mode);
	 ...
	 * @return 保存是否成功
	 * */
	Result saveList(List<Manufacturer> manufacturerList , SaveMode mode);
	 ...
	 * @return 实体集
	 * */
	List<Manufacturer> queryListByIds(List<String> ids);

	/**
	 * 按 id 列表查询 Map
	 * @param ids  主键清单
	 * */
	Map<String, Manufacturer> queryMapByIds(List<String> ids);
	 ...
	 * @return 判断结果
	 */
	Boolean checkExists(Manufacturer manufacturer);
	 ...
	 * @return 查询结果
	 * */
	List<Manufacturer> queryList(ManufacturerVO sample);
	 ...
	 * @return 查询结果
	 * */
	PagedList<Manufacturer> queryPagedList(ManufacturerVO sample,int pageSize,int pageIndex);
