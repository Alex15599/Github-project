...
public class AssetStorageBpmEventAdaptor extends BpmEventAdaptor<AssetStorage, IAssetStorageService> {


	public String BPM_TABLE="eam_asset_storage";
	...
	public AssetStorageBpmEventAdaptor(IAssetStorageService service) {
		super(service);
	}
