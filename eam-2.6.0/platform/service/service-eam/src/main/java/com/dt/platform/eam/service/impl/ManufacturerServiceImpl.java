...
public class ManufacturerServiceImpl extends SuperService<Manufacturer> implements IManufacturerService {
	 ...
	 */
	@Override
	public Result insert(Manufacturer manufacturer,boolean throwsException) {
		Result r=super.insert(manufacturer,throwsException);
		return r;
	}
	...
	public Result insert(Manufacturer manufacturer) {
		return this.insert(manufacturer,true);
	}
	...
	public Result update(Manufacturer manufacturer , SaveMode mode) {
		return this.update(manufacturer,mode,true);
	}
	 ...
	 * */
	@Override
	public Result update(Manufacturer manufacturer , SaveMode mode,boolean throwsException) {
		Result r=super.update(manufacturer , mode , throwsException);
		return r;
	}
	...
	@Override
	public List<Manufacturer> queryListByIds(List<String> ids) {
		return super.queryListByUKeys("id",ids);
	}

	@Override
	public Map<String, Manufacturer> queryMapByIds(List<String> ids) {
		return super.queryMapByUKeys("id",ids, Manufacturer::getId);
	}
	 ...
	 * */
	@Override
	public List<Manufacturer> queryList(ManufacturerVO sample) {
	 ...
	 * */
	@Override
	public PagedList<Manufacturer> queryPagedList(ManufacturerVO sample, int pageSize, int pageIndex) {
	 ...
	 * @return 判断结果
	 */
	public Boolean checkExists(Manufacturer manufacturer) {
		//TDOD 此处添加判断段的代码
		//boolean exists=super.checkExists(manufacturer, SYS_ROLE.NAME);
		//return exists;
		return false;
	}
