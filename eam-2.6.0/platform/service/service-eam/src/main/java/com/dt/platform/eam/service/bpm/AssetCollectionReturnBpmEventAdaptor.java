...
public class AssetCollectionReturnBpmEventAdaptor extends BpmEventAdaptor<AssetCollectionReturn, IAssetCollectionReturnService> {


	public String BPM_TABLE="eam_asset_collection_return";
	...
	public AssetCollectionReturnBpmEventAdaptor(IAssetCollectionReturnService service) {
		super(service);
	}
