...
public interface IBrandService extends  ISimpleIdService<Brand,String> {
	 ...
	 */
	Result insert(Brand brand,boolean throwsException);
	 ...
	 * @return 结果
	 */
	Result update(Brand brand , SaveMode mode,boolean throwsException);
	 ...
	 * @return 保存是否成功
	 * */
	Result save(Brand brand , SaveMode mode,boolean throwsException);
	 ...
	 * @return 实体集
	 * */
	List<Brand> queryListByIds(List<String> ids);

	/**
	 * 按 id 列表查询 Map
	 * @param ids  主键清单
	 * */
	Map<String, Brand> queryMapByIds(List<String> ids);
	 ...
	 * @return 查询结果
	 * */
	List<Brand> queryList(BrandVO sample);
	 ...
	 * @return 查询结果
	 * */
	PagedList<Brand> queryPagedList(BrandVO sample,int pageSize,int pageIndex);
