...
public class FailureRegistrationController extends SuperController {
    ...
    public Result<FailureRegistration> getById(String id) {
        ...
        // join 关联的对象
        failureRegistrationService.dao().fill(failureRegistration).with("originator").with(FailureRegistrationMeta.TYPE_DICT).execute();
    ...
    public Result<PagedList<FailureRegistration>> queryPagedList(FailureRegistrationVO sample) {
        ...
        // join 关联的对象
        failureRegistrationService.dao().fill(list).with("originator").with(FailureRegistrationMeta.TYPE_DICT).execute();
        result.success(true).data(list);
