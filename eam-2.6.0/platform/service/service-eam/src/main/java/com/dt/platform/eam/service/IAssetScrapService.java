...
public interface IAssetScrapService extends ISimpleIdService<AssetScrap,String> {
	 ...
	 * @return 实体集
	 * */
	List<AssetScrap> getByIds(List<String> ids);
	 ...
	 * @return 判断结果
	 */
	Result<AssetScrap> checkExists(AssetScrap assetScrap);
	 ...
	 * 	@return ConditionExpr 条件表达式
	 * */
	ConditionExpr buildQueryCondition(AssetScrap sample,String tableAliase);
	 ...
	 * 导出 Excel
	 * */
	ExcelWriter exportExcel(AssetScrap sample);
