...
public class ContentServiceImpl extends SuperService<Content> implements IContentService {
	 ...
	 */
	@Override
	public Result insert(Content content,boolean throwsException) {
		Result r=super.insert(content,throwsException);
		return r;
	}
	 ...
	 * */
	@Override
	public Result insert(Content content) {
	 ...
	 * */
	@Override
	public Result insertList(List<Content> contentList) {
		return super.insertList(contentList);
	}
	...
	public Result deleteByIdPhysical(String id) {
		...
		content.setId(id);
		try {
			boolean suc = dao.deleteEntity(content);
	...
	public Result deleteByIdLogical(String id) {
		...
		try {
			boolean suc = dao.updateEntity(content,SaveMode.NOT_NULL_FIELDS);
			return suc?ErrorDesc.success():ErrorDesc.failure();
		}
		catch(Exception e) {
			Result r= ErrorDesc.failure();
	 ...
	 * */
	@Override
	public Result update(Content content , SaveMode mode) {
		return this.update(content,mode,true);
	}
	 ...
	 * */
	@Override
	public Result update(Content content , SaveMode mode,boolean throwsException) {
		Result r=super.update(content , mode , throwsException);
		return r;
	}
	 ...
	 * */
	@Override
	public Result updateList(List<Content> contentList , SaveMode mode) {
		return super.updateList(contentList , mode);
	}
	 ...
	 * */
	@Override
	public PagedList<Content> queryPagedList(Content sample, ConditionExpr condition, int pageSize, int pageIndex) {
