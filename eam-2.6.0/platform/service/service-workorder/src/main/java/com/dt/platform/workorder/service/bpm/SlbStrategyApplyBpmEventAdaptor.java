package com.dt.platform.workorder.service.bpm;
 ...
 * @since 2022-07-06 17:20:49
*/

public class SlbStrategyApplyBpmEventAdaptor extends BpmEventAdaptor<SlbStrategyApply,ISlbStrategyApplyService> {

	public String BPM_TABLE="wo_slb_strategy_apply";

	private void updateBillStatus(String id,String status ){
		this.dao().execute("update "+BPM_TABLE+" set status=? where id=?", status, id);
	}

	public SlbStrategyApplyBpmEventAdaptor(ISlbStrategyApplyService service) {
		super(service);
	}
	/***
