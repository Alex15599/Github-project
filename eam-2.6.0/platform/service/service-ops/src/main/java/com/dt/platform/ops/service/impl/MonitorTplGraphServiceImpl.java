...
public class MonitorTplGraphServiceImpl extends SuperService<MonitorTplGraph> implements IMonitorTplGraphService {
	...
	public Result deleteByIdLogical(String id) {
		...
		if(id==null) return ErrorDesc.failure().message("id 不允许为 null 。");
		monitorTplGraph.setId(id);
		monitorTplGraph.setDeleted(true);
	...
	@Override
	public List<MonitorTplGraph> queryListByIds(List<String> ids) {
		return super.queryListByUKeys("id",ids);
	}

	@Override
	public Map<String, MonitorTplGraph> queryMapByIds(List<String> ids) {
		return super.queryMapByUKeys("id",ids, MonitorTplGraph::getId);
	}
	 ...
	 * */
	@Override
	public List<MonitorTplGraph> queryList(MonitorTplGraphVO sample) {
	 ...
	 * */
	@Override
	public PagedList<MonitorTplGraph> queryPagedList(MonitorTplGraphVO sample, int pageSize, int pageIndex) {
