...
public class MonitorNodeValueLastController extends SuperController {
    ...
    @ApiImplicitParams({ 
		@ApiImplicitParam(name = MonitorNodeValueLastVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "547135053407191040"),
		...
		@ApiImplicitParam(name = MonitorNodeValueLastVOMeta.MONITOR_TPL_CODE, value = "监控模版", required = false, dataTypeClass = String.class, example = "tpl_host_linux_script"),
		...
		@ApiImplicitParam(name = MonitorNodeValueLastVOMeta.P_MEMORY_SIZE, value = "物理内存(M)", required = false, dataTypeClass = Long.class),
		@ApiImplicitParam(name = MonitorNodeValueLastVOMeta.V_MEMORY_SIZE, value = "虚拟内存(M)", required = false, dataTypeClass = Long.class),
		@ApiImplicitParam(name = MonitorNodeValueLastVOMeta.P_MEMORY_USED, value = "物理内存使用率", required = false, dataTypeClass = Long.class, example = "0"),
		@ApiImplicitParam(name = MonitorNodeValueLastVOMeta.V_MEMORY_USED, value = "虚拟内存使用率", required = false, dataTypeClass = Long.class, example = "0"),
		...
		@ApiImplicitParam(name = MonitorNodeValueLastVOMeta.RECORD_TIME, value = "记录时间", required = false, dataTypeClass = Date.class, example = "2022-02-18 07:19:22")
	})
