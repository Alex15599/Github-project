...
public interface ISoftwareBaseVersionService extends  ISimpleIdService<SoftwareBaseVersion,String> {
	 ...
	 * @return 查询结果
	 * */
	List<SoftwareBaseVersion> queryList(SoftwareBaseVersionVO sample);
	 ...
	 * @return 查询结果
	 * */
	PagedList<SoftwareBaseVersion> queryPagedList(SoftwareBaseVersionVO sample,int pageSize,int pageIndex);
