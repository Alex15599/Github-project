...
public class SoftwareBaseVersionServiceImpl extends SuperService<SoftwareBaseVersion> implements ISoftwareBaseVersionService {
	 ...
	 * */
	@Override
	public List<SoftwareBaseVersion> getByIds(List<String> ids) {
	 ...
	 * */
	@Override
	public List<SoftwareBaseVersion> queryList(SoftwareBaseVersionVO sample) {
	 ...
	 * */
	@Override
	public PagedList<SoftwareBaseVersion> queryPagedList(SoftwareBaseVersionVO sample, int pageSize, int pageIndex) {
