...
import com.dt.platform.constants.db.OpsTables.OPS_HOST_OS;
...
/**
	...
	public void saveRelation(String hostId,List<String> serviceInfoIds) {
		super.saveRelation(HostOs.class, OPS_HOST_OS.HOST_ID,hostId, ServiceInfo.class,OPS_HOST_OS.SERVICE_INFO_ID,serviceInfoIds,true);
	}
