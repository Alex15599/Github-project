...
function FormPage() {
	...
	const moduleURL="/service-common/sys-backup-db-strategy";
	...
	this.init=function(layui) {
		...
		action=admin.getTempData('sys-backup-db-strategy-form-data-form-action');
		//如果没有修改和保存权限
		...
		if(window.pageExt.form.beforeInit) {
			window.pageExt.form.beforeInit(action,admin.getTempData('sys-backup-db-strategy-form-data'));
		}
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			var area=admin.changePopupArea(null,bodyHeight+footerHeight,'sys-backup-db-strategy-form-data-win');
			if(area==null) return;
			admin.putTempData('sys-backup-db-strategy-form-area', area);
	...
	function fillFormData(formData) {
		if(!formData) {
			formData = admin.getTempData('sys-backup-db-strategy-form-data');
		}
	...
	function saveForm(param,callback) {
		...
		admin.post(api, param, function (data) {
			if (data.success) {
				...
				if(doNext) {
					admin.finishPopupCenterById('sys-backup-db-strategy-form-data-win');
				}
    ...
    function bindButtonEvent() {
	    ...
	    //关闭窗口
	    $("#cancel-button").click(function(){ admin.finishPopupCenterById('sys-backup-db-strategy-form-data-win',this); });
