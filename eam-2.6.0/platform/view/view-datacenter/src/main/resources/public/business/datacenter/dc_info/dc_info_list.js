...
function ListPage() {
	...
	//模块基础路径
	const moduleURL="/service-datacenter/dc-info";
    ...
    function renderTable() {
		...
		fox.renderTable({
			...
			cols: [[
                ...
                { field: 'dcName', align:"left", hide:false, sort: true, title: fox.translate('名称')} ,
                { field: 'dcPosition', align:"left", hide:false, sort: true, title: fox.translate('位置')} ,
                { field: 'dcNotes', align:"left", hide:false, sort: true, title: fox.translate('备注')} ,
	...
	function refreshTableData(sortField,sortType,reset) {
		var value = {};
		value.dcName={ value: $("#dcName").val() ,fuzzy: true };
		value.dcPosition={ value: $("#dcPosition").val() ,fuzzy: true };
		value.dcNotes={ value: $("#dcNotes").val() ,fuzzy: true };
	...
	function showEditForm(data) {
		...
		admin.putTempData('dc-info-form-data', data);
		var area=admin.getTempData('dc-info-form-area');
