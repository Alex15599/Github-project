		...
		table.on('toolbar(data-table)', function(obj){
			...
			switch(obj.event){
				case 'create':
					...
					ps.ids=ids;
					//调用批量删除接口
					top.layer.confirm(fox.translate('确定选择已选中的')+fox.translate('巡检点')+fox.translate('吗？'), function (i) {
						admin.post(moduleURL+"/selected", ps, function (data) {
							if (data.success) {
								admin.finishPopupCenterById("eam-inspection-point-select-list-data-win");
								fox.showMessage(data);
							} else {
								fox.showMessage(data);
							}
