		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'assetId', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('设备'), templet: function (d) { return templet('assetId' ,fox.joinLabel(d.asset,"name",',','','assetId'),d);}}
