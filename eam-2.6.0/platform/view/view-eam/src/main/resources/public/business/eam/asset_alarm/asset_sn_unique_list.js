    ...
    function renderTable() {
        ...
        function renderTableInternal() {
            ...
            var tableConfig={
                ...
                url: moduleURL +'/query-asset-serial-number-unique',
                height: 'full-'+(h+28),
                limit: 50,
                page:false,
                where: ps,
                cols: [[
                    ...
                    ,{ field: 'serialNumber', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('资产序列') , templet: function (d) { return templet('serialNumber',d.serialNumber,d);}  }
