    ...
    function renderTable() {
		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				defaultToolbar: ['filter', 'print','exports',{title: fox.translate('刷新数据','','cmp:table'),layEvent: 'refresh-data',icon: 'layui-icon-refresh-3'}],
				url: moduleURL +'/query-asset-paged-list',
				height: 'full-'+(h+28),
				limit: 50,
				where: ps,
				cols: [[
