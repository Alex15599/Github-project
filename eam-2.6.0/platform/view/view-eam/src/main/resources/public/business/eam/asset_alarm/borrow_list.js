...
function ListPage() {
    ...
    //模块基础路径
    const moduleURL="/service-eam/eam-asset-alarm";
    var dataTable=null;
    var sort=null;
    /**
     * 入口函数，初始化
    ...
    function renderTable() {
        ...
        function renderTableInternal() {
            ...
            var tableConfig={
                ...
                url: moduleURL +'/query-borrow-expiration-data',
                height: 'full-'+(h+28),
                limit: 50,
                page:false,
                where: ps,
                cols: [[
                    ...
                    ,{ field: 'bill', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('借出单据'), templet: function (d) { return templet('bill' ,fox.joinLabel(d.bill,"businessCode") ,d);}}
                    ,{ field: 'bill', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('预计归还时间'), templet: function (d)   { return templet('bill', fox.dateFormat(fox.joinLabel(d.bill,"planReturnDate"),"yyyy-MM-dd"),d); }}
