...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var formAction=admin.getTempData('eam-asset-storage-form-data-form-action');
    //列表页的扩展
    var list={
        /**
         * 列表页初始化前调用
        ...
        downloadBill:function (data){
            var downloadUrl="/service-eam/eam-asset-bill/query-asset-storage-bill";
    ...
    var form={
        ...
        beforeSubmit:function (data) {
            ...
            var content=$(".form-iframe")[0].contentWindow.module.getContent();
        ...
        assetSelectList:function (ifr,win,data) {
            ...
            var queryString="?selectedCode="+timestamp+"&pageType="+formAction
            ...
            ifr.height("450px");
            //设置地址
            win.location="/business/eam/asset_storage/asset_excel_oper.html"+queryString;
        },
        /**
         * 文件上传组件回调
         *  event 类型包括：
