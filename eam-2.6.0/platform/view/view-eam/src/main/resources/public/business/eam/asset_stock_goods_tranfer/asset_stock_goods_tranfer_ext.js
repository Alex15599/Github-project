...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var formAction=admin.getTempData('eam-asset-stock-goods-tranfer-form-data-form-action');
    //列表页的扩展
    var list={
        /**
         * 列表页初始化前调用
        ...
        makeFormQueryString:function(data,queryString,action) {
            admin.putTempData('eam-asset-stock-goods-tranfer-form-ownerType', OWNER_TYPE);
            admin.putTempData('eam-asset-stock-goods-tranfer-form-operType', OPER_TYPE);
            return queryString;
        },
        /**
    ...
    var form={
        ...
        beforeInit:function (action,data) {
            OWNER_TYPE=admin.getTempData('eam-asset-stock-goods-tranfer-form-ownerType');
            OPER_TYPE=admin.getTempData('eam-asset-stock-goods-tranfer-form-operType');
            //获取参数，并调整下拉框查询用的URL
