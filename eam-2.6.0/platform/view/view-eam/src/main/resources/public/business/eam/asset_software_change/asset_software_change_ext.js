...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var formAction=admin.getTempData('eam-asset-software-change-form-data-form-action');
    //列表页的扩展
    var list={
        /**
         * 列表页初始化前调用
    ...
    var form={
        ...
        softwareSelectList:function (ifr,win,data) {
            ...
            //设置 iframe 高度
            ifr.height("400px");
            var queryString="?operType=eam_asset_software_change&pageType="+formAction+"&pid="+pid;
            //设置地址
