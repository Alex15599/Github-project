    ...
    function renderTable() {
        ...
        function renderTableInternal() {
            ...
            var tableConfig={
                ...
                url: moduleURL +'/asset-oper-data-report',
                height: 'full-'+(h+28),
                limit: 50,
                page:false,
                where: ps,
                cols: [[
                    ...
                    ,{ field: 'businessCode', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('操作编码') , templet: function (d) { return templet('businessCode',d.businessCode,d);}  }
