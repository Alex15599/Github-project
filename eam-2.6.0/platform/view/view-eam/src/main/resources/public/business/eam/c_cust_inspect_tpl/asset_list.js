...
function ListPage() {
    ...
    function renderTable() {
        ...
        function renderTableInternal() {
            ...
            var dataUrl='/service-eam/eam-c-cust-inspect-tpl/query-asset-paged-list';
    ...
    function bindRowOperationEvent() {
        ...
        table.on('tool(data-table)', function (obj) {
            ...
            if (layEvent === 'edit') { // 修改
                ...
                top.layer.confirm(fox.translate('确定删除此')+fox.translate('记录')+fox.translate('吗？'), function (i) {
                    top.layer.close(i);

                    top.layer.load(2);
                    admin.request("/service-eam/eam-c-cust-inspect-tpl/remove-asset", { tplId : TPL_ID ,assetId:data.id}, function (data) {
