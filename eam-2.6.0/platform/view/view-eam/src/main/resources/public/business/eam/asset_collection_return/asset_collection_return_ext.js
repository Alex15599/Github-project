...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var list={
        ...
        afterQuery : function (data) {
            console.log("exeucte after",data);
        ...
        downloadBill:function (data){
            ...
            var downloadUrl="/service-eam/eam-asset-bill/query-collection-return-bill";
    ...
    var formAction=admin.getTempData('eam-asset-collection-return-form-data-form-action');
