...
function ListPage() {
	...
	//模块基础路径
	const moduleURL="/service-eam/eam-maintain-report";
	var dataTable=null;
	var sort=null;
	/**
	 * 入口函数，初始化
	...
	function renderTable() {
		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				url: moduleURL +'/maintain-item-report',
				height: 'full-'+(h+28),
				limit: 50,
				page:false,
				where: ps,
				cols: [[
					...
					,{ field: 'cnt', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('数量') , templet: function (d) { return templet('cnt',d.cnt,d);}  }
