		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'useOrganizationId', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('使用公司') , templet: function (d) { return templet('useOrganizationId',fox.getProperty(d,["useOrganization","fullName"]),d);} }
					...
					,{ field: 'sourceDetail', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('来源明细') , templet: function (d) { return templet('sourceDetail',d.sourceDetail,d);}  }
					,{ field: 'authorizationInfo', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('授权信息') , templet: function (d) { return templet('authorizationInfo',d.authorizationInfo,d);}  }
					...
					,{ field: 'registerDate', align:"right", fixed:false, hide:false, sort: true   ,title: fox.translate('登记时间') ,templet: function (d) { return templet('registerDate',fox.dateFormat(d.registerDate,"yyyy-MM-dd"),d); }  }
