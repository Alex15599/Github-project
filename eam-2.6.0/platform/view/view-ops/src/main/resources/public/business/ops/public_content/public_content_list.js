		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'type', align:"left",fixed:false,  hide:false, sort: false  , title: fox.translate('类型'), templet: function (d) { return templet('type' ,fox.joinLabel(d.typeData,"label",',','','type'),d);}}
					...
					,{ field: 'files', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('文件') , templet: function (d) { return templet('files',d.files,d);}  }
		...
		table.on('toolbar(data-table)', function(obj){
			...
			switch(obj.event){
				...
				case 'batch-del':
					...
					break;
				case 'tool-data-share':
					window.pageExt.list.dataShare && window.pageExt.list.dataShare(selected,obj);
					break;
				case 'refresh-data':
					refreshTableData();
					break;
