		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'hostName', align:"left",fixed:false,  hide:false, sort: false, title: fox.translate('主机名称') , templet: function (d) { return templet('hostName',d.hostName,d);}  }
				...
				parseData:function(res){
					...
					var rData=res.data.db_software_info.data;
