    ...
    var list={
        ...
        beforeInit:function () {
            ...
            if(PAGE_TYPE=="view"){
                ...
                var toolsHtml=document.getElementById("toolbarTemplate").innerHTML;
                toolsHtml=toolsHtml.replace(/lay-event="create"/i, "style=\"display:none\"")
                document.getElementById("toolbarTemplate").innerHTML=toolsHtml;
            }
        ...
        beforeQuery:function (conditions,param,location) {
            console.log("parameter:",DB_ID,PAGE_TYPE)
            console.log('beforeQuery',conditions,param,location);

            if(PAGE_TYPE=="create"){
                console.log("parameter set databaseId -1");
                param.databaseId=DB_ID;
            }else{
                console.log("parameter set databaseId DB_ID");
                param.databaseId=DB_ID;
            }
