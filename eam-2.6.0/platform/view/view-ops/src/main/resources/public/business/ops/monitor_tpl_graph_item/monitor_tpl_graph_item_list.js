...
function ListPage() {
	...
	function bindButtonEvent() {
        ...
        function openCreateFrom() {
        	//设置新增是初始化数据
        	var data={};
			admin.putTempData('ops-monitor-tpl-graph-item-form-data-form-action', "create",true);
            showEditForm(data);
        };
	...
	function showEditForm(data) {
		...
		var action=admin.getTempData('ops-monitor-tpl-graph-item-form-data-form-action');
		var queryString="";
		if(data && data.id) queryString='id=' + data.id;
		if(window.pageExt.list.makeFormQueryString) {
			queryString=window.pageExt.list.makeFormQueryString(data,queryString,action);
		}
		admin.putTempData('ops-monitor-tpl-graph-item-form-data', data);
		var area=admin.getTempData('ops-monitor-tpl-graph-item-form-area');
