...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var list={
        ...
        autoTaskMLog:function (data){
            var queryString="?mLogId="+data.id;
            admin.popupCenter({
                title: "日志",
                resize: false,
                offset: [null,null],
                ...
                content: '/business/ops/auto_task_log/auto_task_log_list.html' +queryString,
                finish: function () {
                }
            });
