...
public class EAMTables {
	...
	*/
	public static class EAM_ASSET extends DBTable {
		...
		*/
		 ...
		 * 存放区域
		*/
		public static final DBField REGION_ID = new DBField(DBDataType.STRING , "region_id","regionId","存放区域","存放区域",false,false,true);
		...
		*/
		 ...
		 * 维保价格
		*/
		public static final DBField MAINTENANCE_PRICE = new DBField(DBDataType.DECIMAL , "maintenance_price","maintenancePrice","维保价格","维保价格",false,false,true);
		...
		*/
		 ...
		 * 最后折旧
		*/
		public static final DBField DEPRECIATION_ID = new DBField(DBDataType.STRING , "depreciation_id","depreciationId","最后折旧","最后折旧",false,false,true);
		...
		*/
		 ...
		 * 本年折旧
		*/
		public static final DBField CURRENT_YEAR_DEPRECIATION = new DBField(DBDataType.DECIMAL , "current_year_depreciation","currentYearDepreciation","本年折旧","本年折旧",false,false,true);
		
		/**
		 * 折旧年份
		*/
		public static final DBField DEPRECIATION_YEAR = new DBField(DBDataType.INTEGER , "depreciation_year","depreciationYear","折旧年份","折旧年份",false,false,true);
		...
		*/
		 ...
		 * 短标签1
		*/
		public static final DBField LABEL = new DBField(DBDataType.STRING , "label","label","短标签1","短标签1",false,false,true);
		
		/**
		 * 长标签2
		*/
		public static final DBField LABEL2 = new DBField(DBDataType.STRING , "label2","label2","长标签2","长标签2",false,false,true);
		
		/**
		 * 短标签3
		*/
		public static final DBField LABEL3 = new DBField(DBDataType.STRING , "label3","label3","短标签3","短标签3",false,false,true);
		
		/**
		 * 长标签4
		*/
		public static final DBField LABEL4 = new DBField(DBDataType.STRING , "label4","label4","长标签4","长标签4",false,false,true);
		
		/**
		 * 短标签5
		*/
		public static final DBField LABEL5 = new DBField(DBDataType.STRING , "label5","label5","短标签5","短标签5",false,false,true);
		...
		*/
		 ...
		 * 领用ID
		*/
		public static final DBField COLLECTION_ID = new DBField(DBDataType.STRING , "collection_id","collectionId","领用ID","领用ID",false,false,true);
		
		/**
		 * 借用ID
		*/
		public static final DBField BORROW_ID = new DBField(DBDataType.STRING , "borrow_id","borrowId","借用ID","借用ID",false,false,true);
		
		/**
		 * 报废ID
		*/
		public static final DBField SCRAP_ID = new DBField(DBDataType.STRING , "scrap_id","scrapId","报废ID","报废ID",false,false,true);
	...
	*/
	public static class EAM_ASSET_BORROW_RETURN extends DBTable {
		...
		*/
		 ...
		 * 归还后公司/部门
		*/
		public static final DBField USE_ORGANIZATION_ID = new DBField(DBDataType.STRING , "use_organization_id","useOrganizationId","归还后公司/部门","归还后公司/部门",false,false,true);
		
		/**
		 * 归还后位置
		*/
		public static final DBField POSITION_ID = new DBField(DBDataType.STRING , "position_id","positionId","归还后位置","归还后位置",false,false,true);
		...
		*/
		 ...
		 * 归还日期
		*/
		public static final DBField RETURN_DATE = new DBField(DBDataType.DATE , "return_date","returnDate","归还日期","归还日期",false,false,true);
		...
		*/
		...
		public EAM_ASSET_BORROW_RETURN() {
			this.init($NAME,"资产归还" , ID , BUSINESS_CODE , PROC_ID , STATUS , NAME , USE_ORGANIZATION_ID , POSITION_ID , POSITION_DETAIL , CONTENT , RETURN_DATE , MANAGER_ID , USE_USER_ID , ORIGINATOR_ID , BUSINESS_DATE , ATTACH , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID , SELECTED_CODE);
		}
	...
	*/
	 ...
	 * 资产复制
	*/
	public static class EAM_ASSET_COPY extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_copy";
		...
		*/
		 ...
		 * 复制数量
		*/
		public static final DBField ASSET_NUMBER = new DBField(DBDataType.INTEGER , "asset_number","assetNumber","复制数量","复制数量",false,false,true);
		...
		*/
		...
		public EAM_ASSET_COPY() {
			this.init($NAME,"资产复制" , ID , ASSET_ID , ASSET_NUMBER , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION);
		}
		public static final EAM_ASSET_COPY $TABLE=new EAM_ASSET_COPY();
	}
	
	/**
	 * 资产复制记录
	*/
	public static class EAM_ASSET_COPY_RECORD extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_copy_record";
		...
		*/
		 ...
		 * 复制
		*/
		public static final DBField COPY_ID = new DBField(DBDataType.STRING , "copy_id","copyId","复制","复制",false,false,true);
		
		/**
		 * 资产
		*/
		public static final DBField COPY_SOURCE_ASSET_ID = new DBField(DBDataType.STRING , "copy_source_asset_id","copySourceAssetId","资产","资产",false,false,true);
		
		/**
		 * 资产
		*/
		public static final DBField COPY_TARGET_ASSET_ID = new DBField(DBDataType.STRING , "copy_target_asset_id","copyTargetAssetId","资产","资产",false,false,true);
		...
		*/
		...
		public EAM_ASSET_COPY_RECORD() {
			this.init($NAME,"资产复制记录" , ID , COPY_ID , COPY_SOURCE_ASSET_ID , COPY_TARGET_ASSET_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION);
		}
		public static final EAM_ASSET_COPY_RECORD $TABLE=new EAM_ASSET_COPY_RECORD();
	}
	...
	*/
	public static class EAM_ASSET_DEPRECIATION extends DBTable {
		...
		*/
		 ...
		 * 残值选择
		*/
		public static final DBField RESIDUAL_VALUE_SELECT = new DBField(DBDataType.STRING , "residual_value_select","residualValueSelect","残值选择","残值选择",false,false,true);
		
		/**
		 * 首次折旧方式
		*/
		public static final DBField FIRST_DEPRECIATION_METHOD = new DBField(DBDataType.STRING , "first_depreciation_method","firstDepreciationMethod","首次折旧方式","首次折旧方式",false,false,true);
		...
		*/
		 ...
		 * 规则编排
		*/
		public static final DBField FLOW_CONF = new DBField(DBDataType.STRING , "flow_conf","flowConf","规则编排","规则编排",false,false,true);
		
		public EAM_ASSET_DEPRECIATION() {
			this.init($NAME,"折旧方案" , ID , STATUS , CODE , NAME , METHOD , PRE_RESIDUAL_RATE , RESIDUAL_VALUE_SELECT , FIRST_DEPRECIATION_METHOD , OWN_COMPANY_ID , CATEGORY_ID , SELECTED_CODE , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID , FLOW_CONF);
		}
	 ...
	 * 计算方法
	*/
	public static class EAM_ASSET_DEPRECIATION_CAL_RULE extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_depreciation_cal_rule";
		...
		*/
		 ...
		 * 动作
		*/
		public static final DBField ACTION_CODE = new DBField(DBDataType.STRING , "action_code","actionCode","动作","动作",false,false,true);
		
		/**
		 * 规则编号
		*/
		public static final DBField RULE_NUMBER = new DBField(DBDataType.INTEGER , "rule_number","ruleNumber","规则编号","规则编号",false,false,true);
		
		/**
		 * 字段值
		*/
		public static final DBField COLUMN_VALUE = new DBField(DBDataType.STRING , "column_value","columnValue","字段值","字段值",false,false,true);
		
		/**
		 * 字段名称
		*/
		public static final DBField COLUMN_NAME = new DBField(DBDataType.STRING , "column_name","columnName","字段名称","字段名称",false,false,true);
		
		/**
		 * 计算类型
		*/
		public static final DBField CALCULATION_TYPE = new DBField(DBDataType.STRING , "calculation_type","calculationType","计算类型","计算类型",false,false,true);
		
		/**
		 * 计算方法
		*/
		public static final DBField METHOD_CONTENT = new DBField(DBDataType.STRING , "method_content","methodContent","计算方法","计算方法",false,false,true);
		
		/**
		 * 方法描述
		*/
		public static final DBField METHOD_CONTENT_INFO = new DBField(DBDataType.STRING , "method_content_info","methodContentInfo","方法描述","方法描述",false,false,true);
		
		/**
		 * 返回类型
		*/
		public static final DBField RETURN_TYPE = new DBField(DBDataType.STRING , "return_type","returnType","返回类型","返回类型",false,false,true);
		...
		*/
		...
		public EAM_ASSET_DEPRECIATION_CAL_RULE() {
			this.init($NAME,"计算方法" , ID , DEPRECIATION_ID , STATUS , ACTION_CODE , RULE_NUMBER , COLUMN_VALUE , COLUMN_NAME , CALCULATION_TYPE , METHOD_CONTENT , METHOD_CONTENT_INFO , RETURN_TYPE , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_ASSET_DEPRECIATION_CAL_RULE $TABLE=new EAM_ASSET_DEPRECIATION_CAL_RULE();
	}
	...
	*/
	public static class EAM_ASSET_DEPRECIATION_DETAIL extends DBTable {
		...
		*/
		 ...
		 * 折旧动作
		*/
		public static final DBField ACTION_CODE = new DBField(DBDataType.STRING , "action_code","actionCode","折旧动作","折旧动作",false,false,true);
		...
		*/
		 ...
		 * 折旧规则
		*/
		public static final DBField RESULT = new DBField(DBDataType.STRING , "result","result","折旧规则","折旧规则",false,false,true);
		
		/**
		 * 折旧结果
		*/
		public static final DBField RESULT_STATUS = new DBField(DBDataType.STRING , "result_status","resultStatus","折旧结果","折旧结果",false,false,true);
		
		/**
		 * 结果明细
		*/
		public static final DBField RESULT_DETAIL = new DBField(DBDataType.STRING , "result_detail","resultDetail","结果明细","结果明细",false,false,true);
		...
		*/
		 ...
		 * 资产类别
		*/
		public static final DBField ASSET_CATEGORY_ID = new DBField(DBDataType.STRING , "asset_category_id","assetCategoryId","资产类别","资产类别",false,false,true);
		...
		*/
		 ...
		 * 财务分类
		*/
		public static final DBField ASSET_FINANCE_CATEGORY_ID = new DBField(DBDataType.STRING , "asset_finance_category_id","assetFinanceCategoryId","财务分类","财务分类",false,false,true);
		
		/**
		 * 财务分类
		*/
		public static final DBField ASSET_FINANCE_CATEGORY_NAME = new DBField(DBDataType.STRING , "asset_finance_category_name","assetFinanceCategoryName","财务分类","财务分类",false,false,true);
		...
		*/
		 ...
		 * 采购日期
		*/
		public static final DBField ASSET_PURCHASE_DATE = new DBField(DBDataType.DATE , "asset_purchase_date","assetPurchaseDate","采购日期","采购日期",false,false,true);
		
		/**
		 * 入账日期
		*/
		public static final DBField ASSET_REGISTER_DATE = new DBField(DBDataType.DATE , "asset_register_date","assetRegisterDate","入账日期","入账日期",false,false,true);
		
		/**
		 * 资产原值
		*/
		public static final DBField ASSET_ORIGINAL_UNIT_PRICE = new DBField(DBDataType.DECIMAL , "asset_original_unit_price","assetOriginalUnitPrice","资产原值","资产原值",false,false,true);
		
		/**
		 * 含税单价
		*/
		public static final DBField ASSET_PURCHASE_UNIT_PRICE = new DBField(DBDataType.DECIMAL , "asset_purchase_unit_price","assetPurchaseUnitPrice","含税单价","含税单价",false,false,true);
		
		/**
		 * 资产净值,(当前)
		*/
		public static final DBField ASSET_NAV_PRICE = new DBField(DBDataType.DECIMAL , "asset_nav_price","assetNavPrice","资产净值","(当前)",false,false,true);
		
		/**
		 * 税额
		*/
		public static final DBField ASSET_TAX_AMOUNT_RATE = new DBField(DBDataType.DECIMAL , "asset_tax_amount_rate","assetTaxAmountRate","税额","税额",false,false,true);
		...
		*/
		 ...
		 * 本期残值率
		*/
		public static final DBField ASSET_RESIDUALS_RATE = new DBField(DBDataType.DECIMAL , "asset_residuals_rate","assetResidualsRate","本期残值率","本期残值率",false,false,true);
		
		/**
		 * 本期残值
		*/
		public static final DBField ASSET_RESIDUALS_PRICE = new DBField(DBDataType.DECIMAL , "asset_residuals_price","assetResidualsPrice","本期残值","本期残值",false,false,true);
		...
		*/
		 ...
		 * 已使用期限,月
		*/
		public static final DBField C_USED_SERVICE_LIFE = new DBField(DBDataType.DECIMAL , "c_used_service_life","cUsedServiceLife","已使用期限","月",false,false,true);
		...
		*/
		 ...
		 * 会计期间已使用期限,月
		*/
		public static final DBField ACCOUNTING_SERVICE_LIFE = new DBField(DBDataType.DECIMAL , "accounting_service_life","accountingServiceLife","会计期间已使用期限","月",false,false,true);
		
		/**
		 * 首次折旧,0否,1是
		*/
		public static final DBField FIRST_DEPRECIATION = new DBField(DBDataType.STRING , "first_depreciation","firstDepreciation","首次折旧","0否,1是",false,false,true);
		
		/**
		 * 使用人ID
		*/
		public static final DBField USE_USER_ID = new DBField(DBDataType.STRING , "use_user_id","useUserId","使用人ID","使用人ID",false,false,true);
		
		/**
		 * 使用人
		*/
		public static final DBField USE_USER_NAME = new DBField(DBDataType.STRING , "use_user_name","useUserName","使用人","使用人",false,false,true);
		...
		*/
		 ...
		 * 管理人员
		*/
		public static final DBField MANAGER_NAME = new DBField(DBDataType.STRING , "manager_name","managerName","管理人员","管理人员",false,false,true);
		...
		*/
		 ...
		 * 源资产
		*/
		public static final DBField DETAIL_ID_SOURCE = new DBField(DBDataType.STRING , "detail_id_source","detailIdSource","源资产","源资产",false,false,true);
		
		/**
		 * 目标资产
		*/
		public static final DBField DETAIL_ID_TARGET = new DBField(DBDataType.STRING , "detail_id_target","detailIdTarget","目标资产","目标资产",false,false,true);
		
		/**
		 * 上次折旧单据
		*/
		public static final DBField LAST_OPER_ID = new DBField(DBDataType.STRING , "last_oper_id","lastOperId","上次折旧单据","上次折旧单据",false,false,true);
		
		/**
		 * 上次折旧时间
		*/
		public static final DBField LAST_OPER_TIME = new DBField(DBDataType.DATE , "last_oper_time","lastOperTime","上次折旧时间","上次折旧时间",false,false,true);
	 ...
	 * 折旧排除
	*/
	public static class EAM_ASSET_DEPRECIATION_EXCLUDE extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_depreciation_exclude";
		...
		*/
		...
		public EAM_ASSET_DEPRECIATION_EXCLUDE() {
			this.init($NAME,"折旧排除" , ID , ASSET_ID , DEPRECIATION_ID , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_ASSET_DEPRECIATION_EXCLUDE $TABLE=new EAM_ASSET_DEPRECIATION_EXCLUDE();
	}
	
	/**
	 * 折旧历史
	*/
	public static class EAM_ASSET_DEPRECIATION_HISTORY extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_depreciation_history";
		...
		*/
		 ...
		 * 折旧前价格
		*/
		public static final DBField BEFORE_PRICE = new DBField(DBDataType.DECIMAL , "before_price","beforePrice","折旧前价格","折旧前价格",false,false,true);
		
		/**
		 * 折旧后价格
		*/
		public static final DBField AFTER_PRICE = new DBField(DBDataType.DECIMAL , "after_price","afterPrice","折旧后价格","折旧后价格",false,false,true);
		
		/**
		 * 折旧额
		*/
		public static final DBField DEPRECIATION_PRICE = new DBField(DBDataType.DECIMAL , "depreciation_price","depreciationPrice","折旧额","折旧额",false,false,true);
		...
		*/
		...
		public EAM_ASSET_DEPRECIATION_HISTORY() {
			this.init($NAME,"折旧历史" , ID , ASSET_ID , BUSINESS_CODE , ASSET_CODE , DEPRECIATION_METHOD , ORIGINAL_UNIT_PRICE , BEFORE_PRICE , AFTER_PRICE , DEPRECIATION_PRICE , OPER_USER_ID , RECORD_TIME , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_ASSET_DEPRECIATION_HISTORY $TABLE=new EAM_ASSET_DEPRECIATION_HISTORY();
	}
	...
	*/
	public static class EAM_ASSET_DEPRECIATION_OPER extends DBTable {
		...
		*/
		 ...
		 * 折旧编码
		*/
		public static final DBField DEPRECIATION_CODE = new DBField(DBDataType.STRING , "depreciation_code","depreciationCode","折旧编码","折旧编码",false,false,true);
		...
		*/
		 ...
		 * 开始时间
		*/
		public static final DBField EXECUTION_START_TIME = new DBField(DBDataType.DATE , "execution_start_time","executionStartTime","开始时间","开始时间",false,false,true);
		...
		*/
		...
		public EAM_ASSET_DEPRECIATION_OPER() {
			this.init($NAME,"折旧操作" , ID , BUSINESS_CODE , DEPRECIATION_CODE , STATUS , NAME , DEPRECIATION_ID , CONTENT , BUSINESS_DATE , EXECUTION_START_TIME , EXECUTION_END_TIME , NOTES , ORIGINATOR_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
	...
	*/
	 ...
	 * 领用申请
	*/
	public static class EAM_ASSET_EMPLOYEE_APPLY extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_employee_apply";
		...
		*/
		 ...
		 * 申请数量
		*/
		public static final DBField APPLY_COUNT = new DBField(DBDataType.INTEGER , "apply_count","applyCount","申请数量","申请数量",false,false,true);
		...
		*/
		...
		public EAM_ASSET_EMPLOYEE_APPLY() {
			this.init($NAME,"领用申请" , ID , BUSINESS_CODE , STATUS , NAME , ORG_ID , CONTENT , APPLY_COUNT , NOTES , RECORD_TIME , ORIGINATOR_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID , SELECTED_CODE);
		}
		public static final EAM_ASSET_EMPLOYEE_APPLY $TABLE=new EAM_ASSET_EMPLOYEE_APPLY();
	}
	
	/**
	 * 资产交接
	*/
	public static class EAM_ASSET_EMPLOYEE_HANDOVER extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_employee_handover";
		...
		*/
		 ...
		 * 交接部门
		*/
		public static final DBField RECEIVE_ORG_ID = new DBField(DBDataType.STRING , "receive_org_id","receiveOrgId","交接部门","交接部门",false,false,true);
		
		/**
		 * 交接人
		*/
		public static final DBField RECEIVE_USER_ID = new DBField(DBDataType.STRING , "receive_user_id","receiveUserId","交接人","交接人",false,false,true);
		...
		*/
		...
		public EAM_ASSET_EMPLOYEE_HANDOVER() {
			this.init($NAME,"资产交接" , ID , BUSINESS_CODE , STATUS , NAME , ORG_ID , RECEIVE_ORG_ID , RECEIVE_USER_ID , CONTENT , NOTES , RECORD_TIME , ORIGINATOR_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID , SELECTED_CODE);
		}
		public static final EAM_ASSET_EMPLOYEE_HANDOVER $TABLE=new EAM_ASSET_EMPLOYEE_HANDOVER();
	}
	
	/**
	 * 资产报失
	*/
	public static class EAM_ASSET_EMPLOYEE_LOSS extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_employee_loss";
		...
		*/
		 ...
		 * 报失原因
		*/
		public static final DBField CONTENT = new DBField(DBDataType.STRING , "content","content","报失原因","报失原因",false,false,true);
		...
		*/
		...
		public EAM_ASSET_EMPLOYEE_LOSS() {
			this.init($NAME,"资产报失" , ID , BUSINESS_CODE , STATUS , NAME , CONTENT , NOTES , ORIGINATOR_ID , RECORD_TIME , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID , SELECTED_CODE , ORG_ID);
		}
		public static final EAM_ASSET_EMPLOYEE_LOSS $TABLE=new EAM_ASSET_EMPLOYEE_LOSS();
	}
	
	/**
	 * 资产报修
	*/
	public static class EAM_ASSET_EMPLOYEE_REPAIR extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_employee_repair";
		...
		*/
		 ...
		 * 故障原因
		*/
		public static final DBField CONTENT = new DBField(DBDataType.STRING , "content","content","故障原因","故障原因",false,false,true);
		...
		*/
		...
		public EAM_ASSET_EMPLOYEE_REPAIR() {
			this.init($NAME,"资产报修" , ID , BUSINESS_CODE , STATUS , NAME , ORG_ID , CONTENT , PICTURE_ID , NOTES , ORIGINATOR_ID , RECORD_TIME , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID , SELECTED_CODE);
		}
		public static final EAM_ASSET_EMPLOYEE_REPAIR $TABLE=new EAM_ASSET_EMPLOYEE_REPAIR();
	}
	...
	*/
	public static class EAM_ASSET_LABEL extends DBTable {
		...
		*/
		 ...
		 * 字体
		*/
		public static final DBField FONT_TYPE = new DBField(DBDataType.STRING , "font_type","fontType","字体","字体",false,false,true);
		
		/**
		 * 字体路径
		*/
		public static final DBField FONT_PATH = new DBField(DBDataType.STRING , "font_path","fontPath","字体路径","字体路径",false,false,true);
	...
	*/
	 ...
	 * 标签布局
	*/
	public static class EAM_ASSET_LABEL_LAYOUT extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_label_layout";
		...
		*/
		...
		public EAM_ASSET_LABEL_LAYOUT() {
			this.init($NAME,"标签布局" , ID , TPL_ID , COL_ID , COL_CODE , TYPE , ROW_NUMBER , ROW_HEIGHT , ROW_SPAN , COL_SPAN , SORT , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_ASSET_LABEL_LAYOUT $TABLE=new EAM_ASSET_LABEL_LAYOUT();
	}
	...
	*/
	public static class EAM_ASSET_LABEL_PAPER extends DBTable {
		...
		*/
		 ...
		 * 实现动作
		*/
		public static final DBField ACTION_CODE = new DBField(DBDataType.STRING , "action_code","actionCode","实现动作","实现动作",false,false,true);
		...
		*/
		...
		public EAM_ASSET_LABEL_PAPER() {
			this.init($NAME,"纸张类型" , ID , NAME , STATUS , W , H , ACTION_CODE , TYPE , COLUMN_NUMBER , SORT , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
	...
	*/
	 ...
	 * 设备机柜
	*/
	public static class EAM_ASSET_RACK extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_rack";
		...
		*/
		...
		public EAM_ASSET_RACK() {
			this.init($NAME,"设备机柜" , ID , CODE , NAME , TYPE , STATUS , RACK_ID , PARENT_ID , HIERARCHY , HIERARCHY_NAME , SORT , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_ASSET_RACK $TABLE=new EAM_ASSET_RACK();
	}
	
	/**
	 * 机柜
	*/
	public static class EAM_ASSET_RACK_INFO extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_rack_info";
		...
		*/
		...
		public static final EAM_ASSET_RACK_INFO $TABLE=new EAM_ASSET_RACK_INFO();
	}
	
	/**
	 * 存放区域
	*/
	public static class EAM_ASSET_REGION extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_region";
		...
		*/
		 ...
		 * 名称
		*/
		public static final DBField REGION_NAME = new DBField(DBDataType.STRING , "region_name","regionName","名称","名称",false,false,true);
		
		/**
		 * 编码
		*/
		public static final DBField REGION_CODE = new DBField(DBDataType.STRING , "region_code","regionCode","编码","编码",false,false,true);
		...
		*/
		...
		public EAM_ASSET_REGION() {
			this.init($NAME,"存放区域" , ID , STATUS , REGION_NAME , REGION_CODE , PARENT_ID , SORT , HIERARCHY , HIERARCHY_NAME , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_ASSET_REGION $TABLE=new EAM_ASSET_REGION();
	}
	...
	*/
	public static class EAM_ASSET_SCRAP extends DBTable {
		...
		*/
		 ...
		 * 报废方式
		*/
		public static final DBField METHOD = new DBField(DBDataType.STRING , "method","method","报废方式","报废方式",false,false,true);
		...
		*/
		...
		public EAM_ASSET_SCRAP() {
			this.init($NAME,"资产报废" , ID , BUSINESS_CODE , PROC_ID , STATUS , CLEAN_STATUS , NAME , METHOD , SCRAP_DATE , CONTENT , ORIGINATOR_ID , BUSINESS_DATE , ATTACH , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID , SELECTED_CODE , CHS_TYPE , CHS_STATUS , CHS_VERSION , CHANGE_INSTANCE_ID , SUMMARY , LATEST_APPROVER_ID , LATEST_APPROVER_NAME , NEXT_APPROVER_IDS , NEXT_APPROVER_NAMES , APPROVAL_OPINION);
		}
	...
	*/
	 ...
	 * 资产状态
	*/
	public static class EAM_ASSET_STATUS extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_status";
		...
		*/
		...
		public EAM_ASSET_STATUS() {
			this.init($NAME,"资产状态" , ID , CODE , NAME , TYPE , SORT , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_ASSET_STATUS $TABLE=new EAM_ASSET_STATUS();
	}
	
	/**
	 * 状态规则
	*/
	public static class EAM_ASSET_STATUS_RULE extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_status_rule";
		...
		*/
		 ...
		 * 操作编码
		*/
		public static final DBField OPER_CODE = new DBField(DBDataType.STRING , "oper_code","operCode","操作编码","操作编码",false,false,true);
		
		/**
		 * 条件
		*/
		public static final DBField OPER_CONDITION = new DBField(DBDataType.STRING , "oper_condition","operCondition","条件","条件",false,false,true);
		...
		*/
		...
		public EAM_ASSET_STATUS_RULE() {
			this.init($NAME,"状态规则" , ID , STATUS , OPER_CODE , OPER_CONDITION , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_ASSET_STATUS_RULE $TABLE=new EAM_ASSET_STATUS_RULE();
	}
	
	/**
	 * 状态规则值
	*/
	public static class EAM_ASSET_STATUS_RULE_V extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_status_rule_v";
		...
		*/
		...
		public EAM_ASSET_STATUS_RULE_V() {
			this.init($NAME,"状态规则值" , ID , OPER_CODE , STATUS_CODE , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_ASSET_STATUS_RULE_V $TABLE=new EAM_ASSET_STATUS_RULE_V();
	}
	...
	*/
	 ...
	 * 单据关联
	*/
	public static class EAM_BILL_RELATION extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_bill_relation";
		...
		*/
		 ...
		 * 主节点
		*/
		public static final DBField MASTER_ID = new DBField(DBDataType.STRING , "master_id","masterId","主节点","主节点",false,false,true);
		
		/**
		 * 从节点
		*/
		public static final DBField SLAVER_ID = new DBField(DBDataType.STRING , "slaver_id","slaverId","从节点","从节点",false,false,true);
		...
		*/
		...
		public EAM_BILL_RELATION() {
			this.init($NAME,"单据关联" , ID , MASTER_ID , SLAVER_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_BILL_RELATION $TABLE=new EAM_BILL_RELATION();
	}
	...
	*/
	 ...
	 * 巡检记录
	*/
	public static class EAM_C_CUST_INSPECT_ITEM extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_c_cust_inspect_item";
		...
		*/
		 ...
		 * 巡检人
		*/
		public static final DBField INSPECT_USER_ID = new DBField(DBDataType.STRING , "inspect_user_id","inspectUserId","巡检人","巡检人",false,false,true);
		...
		*/
		 ...
		 * 设备编号
		*/
		public static final DBField ASSET_CODE = new DBField(DBDataType.STRING , "asset_code","assetCode","设备编号","设备编号",false,false,true);
		...
		*/
		 ...
		 * 设备序列
		*/
		public static final DBField ASSET_SEQ = new DBField(DBDataType.STRING , "asset_seq","assetSeq","设备序列","设备序列",false,false,true);
		...
		*/
		...
		public EAM_C_CUST_INSPECT_ITEM() {
			this.init($NAME,"巡检记录" , ID , OWNER_ID , STATUS , ASSET_ID , PICTURE_ID , INSPECT_USER_ID , RECORD_TIME , CT , POS , ASSET_CODE , ASSET_NAME , ASSET_MODEL , ASSET_SEQ , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_C_CUST_INSPECT_ITEM $TABLE=new EAM_C_CUST_INSPECT_ITEM();
	}
	
	/**
	 * 执行日志
	*/
	public static class EAM_C_CUST_INSPECT_LOG extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_c_cust_inspect_log";
	 ...
	 * 巡检计划
	*/
	public static class EAM_C_CUST_INSPECT_PLAN extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_c_cust_inspect_plan";
		...
		*/
		 ...
		 * 追加
		*/
		public static final DBField ACTION_ADD = new DBField(DBDataType.STRING , "action_add","actionAdd","追加","追加",false,false,true);
		
		/**
		 * 负责人
		*/
		public static final DBField INSPECT_USER_ID = new DBField(DBDataType.STRING , "inspect_user_id","inspectUserId","负责人","负责人",false,false,true);
		...
		*/
		 ...
		 * 触发周期
		*/
		public static final DBField CRONTAB = new DBField(DBDataType.STRING , "crontab","crontab","触发周期","触发周期",false,false,true);
		...
		*/
		 ...
		 * 上次执行时间
		*/
		public static final DBField LAST_TIME = new DBField(DBDataType.DATE , "last_time","lastTime","上次执行时间","上次执行时间",false,false,true);
		
		/**
		 * 下次执行时间
		*/
		public static final DBField NEXT_TIME = new DBField(DBDataType.DATE , "next_time","nextTime","下次执行时间","下次执行时间",false,false,true);
		...
		*/
		...
		public EAM_C_CUST_INSPECT_PLAN() {
			this.init($NAME,"巡检计划" , ID , NAME , STATUS , ACTION_ADD , INSPECT_USER_ID , TPL_ID , CRONTAB , NOTES , LAST_TIME , NEXT_TIME , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION);
		}
		public static final EAM_C_CUST_INSPECT_PLAN $TABLE=new EAM_C_CUST_INSPECT_PLAN();
	}
	
	/**
	 * 巡检任务单
	*/
	public static class EAM_C_CUST_INSPECT_TASK extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_c_cust_inspect_task";
	 ...
	 * 巡检模版
	*/
	public static class EAM_C_CUST_INSPECT_TPL extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_c_cust_inspect_tpl";
		...
		*/
		...
		public EAM_C_CUST_INSPECT_TPL() {
			this.init($NAME,"巡检模版" , ID , NAME , STATUS , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION);
		}
		public static final EAM_C_CUST_INSPECT_TPL $TABLE=new EAM_C_CUST_INSPECT_TPL();
	}
	
	/**
	 * 设备
	*/
	public static class EAM_C_CUST_INSPECT_TPL_ASSET extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_c_cust_inspect_tpl_asset";
		...
		*/
		...
		public EAM_C_CUST_INSPECT_TPL_ASSET() {
			this.init($NAME,"设备" , ID , OWNER_ID , ASSET_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_C_CUST_INSPECT_TPL_ASSET $TABLE=new EAM_C_CUST_INSPECT_TPL_ASSET();
	}
	
	/**
	 * 巡检人员
	*/
	public static class EAM_C_CUST_INSPECT_USER_R extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_c_cust_inspect_user_r";
		...
		*/
		 ...
		 * 分组
		*/
		public static final DBField GROUP = new DBField(DBDataType.STRING , "group","group","分组","分组",false,false,true);
		...
		*/
		...
		public EAM_C_CUST_INSPECT_USER_R() {
			this.init($NAME,"巡检人员" , ID , CODE , GROUP , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION);
		}
		public static final EAM_C_CUST_INSPECT_USER_R $TABLE=new EAM_C_CUST_INSPECT_USER_R();
	}
	
	/**
	 * 巡检人员
	*/
	public static class EAM_C_CUST_INSPECT_USER_S extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_c_cust_inspect_user_s";
		...
		*/
		 ...
		 * 巡检人
		*/
		public static final DBField USER_ID = new DBField(DBDataType.STRING , "user_id","userId","巡检人","巡检人",false,false,true);
		...
		*/
		...
		public EAM_C_CUST_INSPECT_USER_S() {
			this.init($NAME,"巡检人员" , ID , OWNER_ID , USER_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_C_CUST_INSPECT_USER_S $TABLE=new EAM_C_CUST_INSPECT_USER_S();
	}
	
	/**
	 * 报修申请
	*/
	public static class EAM_C_CUST_REPAIR_APPLY extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_c_cust_repair_apply";
		...
		*/
		 ...
		 * 发起人
		*/
		public static final DBField REPORT_USER_NAME = new DBField(DBDataType.STRING , "report_user_name","reportUserName","发起人","发起人",false,false,true);
		
		/**
		 * 使用人
		*/
		public static final DBField REPORT_USER_ID = new DBField(DBDataType.STRING , "report_user_id","reportUserId","使用人","使用人",false,false,true);
		...
		*/
		 ...
		 * 处理人
		*/
		public static final DBField PROCESS_USER_ID = new DBField(DBDataType.STRING , "process_user_id","processUserId","处理人","处理人",false,false,true);
	 ...
	 * 内容
	*/
	public static class EAM_C_CUST_REPIAR_ITEM extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_c_cust_repiar_item";
		...
		*/
		 ...
		 * 报修
		*/
		public static final DBField REPAIR_ID = new DBField(DBDataType.STRING , "repair_id","repairId","报修","报修",false,false,true);
		...
		*/
		...
		public EAM_C_CUST_REPIAR_ITEM() {
			this.init($NAME,"内容" , ID , REPAIR_ID , PROCESS_USER_ID , CT , RECORD_TIME , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_C_CUST_REPIAR_ITEM $TABLE=new EAM_C_CUST_REPIAR_ITEM();
	}
	...
	public static class EAM_CATEGORY_FINANCE extends DBTable {
		...
		*/
		...
		public EAM_CATEGORY_FINANCE() {
			this.init($NAME,"财务分类" , ID , STATUS , CATEGORY_NAME , CATEGORY_FULLNAME , CATEGORY_CODE , SERVICE_LIFE , PARENT_ID , SORT , HIERARCHY , HIERARCHY_NAME , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
	...
	*/
	public static class EAM_CODE_RULE extends DBTable {
		...
		*/
		 ...
		 * 数字位数
		*/
		public static final DBField NUMBER_SEQ = new DBField(DBDataType.INTEGER , "number_seq","numberSeq","数字位数","数字位数",false,false,true);
	...
	*/
	 ...
	 * 执行日志
	*/
	public static class EAM_INSPECTION_LOG extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_inspection_log";
		...
		*/
		...
		public EAM_INSPECTION_LOG() {
			this.init($NAME,"执行日志" , ID , PLAN_ID , EXECUTE_TIME , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , EXECUTED , ERRORS);
		}
		public static final EAM_INSPECTION_LOG $TABLE=new EAM_INSPECTION_LOG();
	}
	...
	*/
	public static class EAM_INSPECTION_PLAN extends DBTable {
		...
		*/
		 ...
		 * 位置范围
		*/
		public static final DBField POS_DETAIL = new DBField(DBDataType.STRING , "pos_detail","posDetail","位置范围","位置范围",false,false,true);
		...
		*/
		...
		public EAM_INSPECTION_PLAN() {
			this.init($NAME,"巡检计划" , ID , PLAN_CODE , NAME , STATUS , PLAN_STATUS , PLAN_TYPE , LEADER_ID , GROUP_ID , POS_DETAIL , START_DATE , END_DATE , ACTION_CYCLE_ID , INSPECTION_METHOD , COMPLETION_TIME , OVERTIME_METHOD , REMIND_TIME , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION , SELECTED_CODE);
		}
	...
	public static class EAM_INSPECTION_POINT extends DBTable {
		...
		*/
		...
		public EAM_INSPECTION_POINT() {
			this.init($NAME,"巡检点" , ID , CODE , NAME , STATUS , CONTENT , ROUTE_ID , RFID , POS_ID , POS , POS_LONGITUDE , POS_LATITUDE , PICTURE_ID , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , SELECTED_CODE , VERSION);
		}
	...
	*/
	public static class EAM_INSPECTION_TASK extends DBTable {
		...
		*/
		 ...
		 * 任务单据
		*/
		public static final DBField TASK_CODE = new DBField(DBDataType.STRING , "task_code","taskCode","任务单据","任务单据",false,false,true);
		...
		*/
		 ...
		 * 巡检班组
		*/
		public static final DBField GROUP_ID = new DBField(DBDataType.STRING , "group_id","groupId","巡检班组","巡检班组",false,false,false);
	...
	*/
	public static class EAM_INSPECTION_TASK_POINT extends DBTable {
		...
		*/
		 ...
		 * 巡检点
		*/
		public static final DBField POINT_NAME = new DBField(DBDataType.STRING , "point_name","pointName","巡检点","巡检点",false,false,true);
	...
	*/
	 ...
	 * 盘点反馈
	*/
	public static class EAM_INVENTORY_FEEDBACK extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_inventory_feedback";
		...
		*/
		...
		public EAM_INVENTORY_FEEDBACK() {
			this.init($NAME,"盘点反馈" , ID , INVENTORY_ID , STATUS , USER_ID , CONTENT , PICTURE_ID , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_INVENTORY_FEEDBACK $TABLE=new EAM_INVENTORY_FEEDBACK();
	}
	
	/**
	 * 反馈消息
	*/
	public static class EAM_INVENTORY_FEEDBACK_MSG extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_inventory_feedback_msg";
		...
		*/
		 ...
		 * 反馈
		*/
		public static final DBField FEEDBACK_ID = new DBField(DBDataType.STRING , "feedback_id","feedbackId","反馈","反馈",false,false,true);
		...
		*/
		 ...
		 * 时间
		*/
		public static final DBField RECORD_TIME = new DBField(DBDataType.DATE , "record_time","recordTime","时间","时间",false,false,true);
		...
		*/
		...
		public EAM_INVENTORY_FEEDBACK_MSG() {
			this.init($NAME,"反馈消息" , ID , FEEDBACK_ID , USER_ID , RECORD_TIME , CONTENT , PICTURE_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_INVENTORY_FEEDBACK_MSG $TABLE=new EAM_INVENTORY_FEEDBACK_MSG();
	}
	...
	*/
	public static class EAM_MAINTAIN_PLAN extends DBTable {
		...
		*/
		 ...
		 * 预计工时(小时)
		*/
		public static final DBField TOTAL_COST = new DBField(DBDataType.DECIMAL , "total_cost","totalCost","预计工时","小时)",false,false,true);
		
		/**
		 * 超时时间(小时)
		*/
		public static final DBField TIMEOUT = new DBField(DBDataType.DECIMAL , "timeout","timeout","超时时间","小时)",false,false,true);
		...
		*/
		...
		public EAM_MAINTAIN_PLAN() {
			this.init($NAME,"保养方案" , ID , CODE , NAME , STATUS , ASSET_ID , GROUP_ID , MAINTAIN_TYPE , CYCLE_METHOD , ACTION_CYCLE_ID , START_TIME , END_TIME , TOTAL_COST , TIMEOUT , INFO , NOTES , ORIGINATOR_ID , SELECTED_CODE , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION);
		}
	...
	*/
	public static class EAM_MAINTAIN_PROJECT extends DBTable {
		...
		*/
		 ...
		 * 保养内容
		*/
		public static final DBField CONTENT = new DBField(DBDataType.STRING , "content","content","保养内容","保养内容",false,false,true);
		...
		*/
		...
		public EAM_MAINTAIN_PROJECT() {
			this.init($NAME,"保养项目" , ID , CODE , STATUS , NAME , CONTENT , MAINTAIN_TYPE , BASE_COST , ACTION_CYCLE_ID , ATTACH_ID , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , SELECTED_CODE , VERSION);
		}
	...
	*/
	public static class EAM_MAINTAIN_TASK extends DBTable {
		...
		*/
		 ...
		 * 任务单据
		*/
		public static final DBField BUSINESS_CODE = new DBField(DBDataType.STRING , "business_code","businessCode","任务单据","任务单据",false,false,true);
		...
		*/
		 ...
		 * 执行班组
		*/
		public static final DBField GROUP_ID = new DBField(DBDataType.STRING , "group_id","groupId","执行班组","执行班组",false,false,false);
		...
		*/
		 ...
		 * 位置
		*/
		public static final DBField ASSET_POS = new DBField(DBDataType.STRING , "asset_pos","assetPos","位置","位置",false,false,true);
		
		/**
		 * 保养结果
		*/
		public static final DBField CONTENT = new DBField(DBDataType.STRING , "content","content","保养结果","保养结果",false,false,true);
		...
		*/
		 ...
		 * 预计工时
		*/
		public static final DBField TOTAL_COST = new DBField(DBDataType.DECIMAL , "total_cost","totalCost","预计工时","预计工时",false,false,true);
		...
		*/
		 ...
		 * 费用(元)
		*/
		public static final DBField COST = new DBField(DBDataType.DECIMAL , "cost","cost","费用","元)",false,false,true);
	...
	public static class EAM_MAINTAIN_TASK_PROJECT extends DBTable {
		...
		*/
		...
		public EAM_MAINTAIN_TASK_PROJECT() {
			this.init($NAME,"保养项目" , ID , PROJECT_ID , TASK_ID , STATUS , CONTENT , PROJECT_CODE , PROJECT_NAME , PROJECT_MAINTAIN_TYPE , PROJECT_BASE_COST , PROJECT_ATTACH_ID , PROJECT_NOTES , BASE_COST , START_TIME , END_TIME , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , SELECTED_CODE , VERSION);
		}
	...
	public static class EAM_MAINTAINER extends DBTable {
		...
		*/
		...
		public EAM_MAINTAINER() {
			this.init($NAME,"维保厂商" , ID , CODE , MAINTAINER_NAME , BUSINESS_CONTACTS , BUSINESS_CONTACTS_INFO , AFTER_SALES_CONTACTS , AFTER_SALES_CONTACTS_INFO , UNIT_CODE , ADDRESS , MAINTAINER_NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
	...
	public static class EAM_MANUFACTURER extends DBTable {
		...
		*/
		...
		public EAM_MANUFACTURER() {
			this.init($NAME,"生产厂商" , ID , CODE , MANUFACTURER_NAME , LOCATION , MANUFACTURER_NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
	...
	*/
	 ...
	 * 执行日志
	*/
	public static class EAM_PLAN_EXECUTE_LOG extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_plan_execute_log";
		...
		*/
		...
		public EAM_PLAN_EXECUTE_LOG() {
			this.init($NAME,"执行日志" , ID , PLAN_ID , EXECUTE_TIME , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , EXECUTED , ERRORS);
		}
		public static final EAM_PLAN_EXECUTE_LOG $TABLE=new EAM_PLAN_EXECUTE_LOG();
	}
	...
	*/
	public static class EAM_POSITION extends DBTable {
		...
		*/
		...
		public EAM_POSITION() {
			this.init($NAME,"存放位置" , ID , CODE , NAME , STATUS , PARENT_ID , HIERARCHY , HIERARCHY_NAME , SORT , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
