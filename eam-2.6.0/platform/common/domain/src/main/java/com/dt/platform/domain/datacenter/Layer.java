...
public class Layer extends Entity {
	...
	public static final DBTable TABLE =DC_LAYER.$TABLE;
	...
	*/
	@Transient
	public Layer setDeleted(Boolean deletedBool) {
		if(deletedBool==null) {
			this.deleted=null;
		} else {
	...
	*/
	...
	/**
	 * 将 Map 转换成 Layer
	 * @param layerMap 包含实体信息的 Map 对象
	 * @return Layer , 转换好的的 Layer 对象
	*/
	@Transient
	public static Layer createFrom(Map<String,Object> layerMap) {
		if(layerMap==null) return null;
		Layer po = EntityContext.create(Layer.class, layerMap);
		return po;
	}
	...
	*/
	@Transient
	public static Layer createFrom(Object pojo) {
		if(pojo==null) return null;
		Layer po = EntityContext.create(Layer.class,pojo);
		return po;
	}
	...
	*/
	...
	public static Layer create() {
		return EntityContext.create(Layer.class);
	}
}