...
import com.dt.platform.constants.db.WorkorderTables.WO_SERVICE_DESK;
 ...
 * @sign 279BD2AD179597FF3C3270AD0F79B879
 * 此文件由工具自动生成，请勿修改。若表结构或配置发生变动，请使用工具重新生成。
*/

@Table(name = "wo_service_desk")
public class ServiceDesk extends Entity {

	private static final long serialVersionUID = 1L;

	public static final DBTable TABLE =WO_SERVICE_DESK.$TABLE;
	...
	*/
	 ...
	 * 流程编码：流程编码
	*/
	@ApiModelProperty(required = false,value="流程编码" , notes = "流程编码")
	...
	*/
	@Transient
	public ServiceDesk setDeleted(Boolean deletedBool) {
		if(deletedBool==null) {
			this.deleted=null;
		} else {
	...
	*/
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return ServiceDesk , 转换好的 ServiceDesk 对象
	*/
	@Transient
	 ...
	 * @return ServiceDesk , 转换好的 PoJo 对象
	*/
	@Transient
	...
	/**
	 * 将 Map 转换成 ServiceDesk
	 * @param serviceDeskMap 包含实体信息的 Map 对象
	 * @return ServiceDesk , 转换好的的 ServiceDesk 对象
	*/
	@Transient
	public static ServiceDesk createFrom(Map<String,Object> serviceDeskMap) {
		if(serviceDeskMap==null) return null;
		ServiceDesk po = EntityContext.create(ServiceDesk.class, serviceDeskMap);
		return po;
	}

	/**
	 * 将 Pojo 转换成 ServiceDesk
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return ServiceDesk , 转换好的的 ServiceDesk 对象
	*/
	@Transient
	public static ServiceDesk createFrom(Object pojo) {
		if(pojo==null) return null;
		ServiceDesk po = EntityContext.create(ServiceDesk.class,pojo);
		return po;
	}

	/**
	 * 创建一个 ServiceDesk，等同于 new
	 * @return ServiceDesk 对象
	*/
	@Transient
	public static ServiceDesk create() {
		return EntityContext.create(ServiceDesk.class);
	}
}