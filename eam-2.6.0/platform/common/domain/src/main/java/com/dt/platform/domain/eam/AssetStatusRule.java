...
public class AssetStatusRule extends Entity {
	...
	public static final DBTable TABLE =EAM_ASSET_STATUS_RULE.$TABLE;
	...
	*/
	@Transient
	public AssetStatusRule setDeleted(Boolean deletedBool) {
		if(deletedBool==null) {
			this.deleted=null;
		} else {
	...
	*/
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return AssetStatusRule , 转换好的 AssetStatusRule 对象
	*/
	@Transient
	 ...
	 * @return AssetStatusRule , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	...
	/**
	 * 创建一个 AssetStatusRule，等同于 new
	 * @return AssetStatusRule 对象
	*/
	@Transient
