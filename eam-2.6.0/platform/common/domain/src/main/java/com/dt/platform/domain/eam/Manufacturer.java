...
import com.dt.platform.constants.db.EAMTables.EAM_MANUFACTURER;
...
@Table(name = "eam_manufacturer")
public class Manufacturer extends Entity {

	private static final long serialVersionUID = 1L;

	public static final DBTable TABLE =EAM_MANUFACTURER.$TABLE;
	...
	*/
	@Transient
	public Manufacturer setDeleted(Boolean deletedBool) {
		if(deletedBool==null) {
			this.deleted=null;
		} else {
	...
	*/
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return Manufacturer , 转换好的 Manufacturer 对象
	*/
	@Transient
	 ...
	 * @return Manufacturer , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	...
	/**
	 * 将 Map 转换成 Manufacturer
	 * @param manufacturerMap 包含实体信息的 Map 对象
	 * @return Manufacturer , 转换好的的 Manufacturer 对象
	*/
	@Transient
	public static Manufacturer createFrom(Map<String,Object> manufacturerMap) {
		if(manufacturerMap==null) return null;
		Manufacturer po = EntityContext.create(Manufacturer.class, manufacturerMap);
		return po;
	}

	/**
	 * 将 Pojo 转换成 Manufacturer
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return Manufacturer , 转换好的的 Manufacturer 对象
	*/
	@Transient
	public static Manufacturer createFrom(Object pojo) {
		if(pojo==null) return null;
		Manufacturer po = EntityContext.create(Manufacturer.class,pojo);
		return po;
	}

	/**
	 * 创建一个 Manufacturer，等同于 new
	 * @return Manufacturer 对象
	*/
	@Transient
