...
import com.dt.platform.constants.db.WorkorderTables.WO_SERVER_APPLY;
...
@Table(name = "wo_server_apply")
public class ServerApply extends Entity {

	private static final long serialVersionUID = 1L;

	public static final DBTable TABLE =WO_SERVER_APPLY.$TABLE;
	...
	*/
	 ...
	 * 系统域名：系统域名
	*/
	@ApiModelProperty(required = false,value="系统域名" , notes = "系统域名")
	...
	*/
	...
	/**
	 * serverInfoIds：serverInfoIds
	*/
	@ApiModelProperty(required = false,value="serverInfoIds" , notes = "serverInfoIds")
	private List<String> serverInfoIds;
	...
	*/
	@Transient
	public ServerApply setDeleted(Boolean deletedBool) {
		if(deletedBool==null) {
			this.deleted=null;
		} else {
	...
	*/
	...
	/**
	 * 添加 serverInfoList
	 * @param serverInfo serverInfoList
	 * @return 当前对象
	*/
	public ServerApply addServerInfo(ServerInfo... serverInfo) {
		if(this.serverInfoList==null) serverInfoList=new ArrayList<>();
		this.serverInfoList.addAll(Arrays.asList(serverInfo));
		return this;
	}
	 ...
	 * 获得 serverInfoIds<br>
	 * serverInfoIds
	 * @return serverInfoIds
	*/
	public List<String> getServerInfoIds() {
		return serverInfoIds;
	}
	...
	*/
	public ServerApply setServerInfoIds(List<String> serverInfoIds) {
		this.serverInfoIds=serverInfoIds;
		return this;
	}
	
	/**
	 * 添加 serverInfoIds
	 * @param serverInfoId serverInfoIds
	 * @return 当前对象
	*/
	public ServerApply addServerInfoId(String... serverInfoId) {
		if(this.serverInfoIds==null) serverInfoIds=new ArrayList<>();
		this.serverInfoIds.addAll(Arrays.asList(serverInfoId));
		return this;
	}
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public ServerApply addHistoricProcess(ProcessInstance... historicProcess) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public ServerApply addCurrentProcess(ProcessInstance... currentProcess) {
	...
	*/
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return ServerApply , 转换好的 ServerApply 对象
	*/
	@Transient
	 ...
	 * @return ServerApply , 转换好的 PoJo 对象
	*/
	@Transient
	...
	/**
	 * 将 Map 转换成 ServerApply
	 * @param serverApplyMap 包含实体信息的 Map 对象
	 * @return ServerApply , 转换好的的 ServerApply 对象
	*/
	@Transient
	public static ServerApply createFrom(Map<String,Object> serverApplyMap) {
		if(serverApplyMap==null) return null;
		ServerApply po = EntityContext.create(ServerApply.class, serverApplyMap);
		return po;
	}

	/**
	 * 将 Pojo 转换成 ServerApply
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return ServerApply , 转换好的的 ServerApply 对象
	*/
	@Transient
	public static ServerApply createFrom(Object pojo) {
		if(pojo==null) return null;
		ServerApply po = EntityContext.create(ServerApply.class,pojo);
		return po;
	}

	/**
	 * 创建一个 ServerApply，等同于 new
	 * @return ServerApply 对象
	*/
	@Transient
	public static ServerApply create() {
		return EntityContext.create(ServerApply.class);
	}
}