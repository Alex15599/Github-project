...
public class AssetStockGoodsAdjust extends Entity {
	...
	*/
	 ...
	 * 调整说明：调整说明
	*/
	@ApiModelProperty(required = false,value="调整说明" , notes = "调整说明")
	...
	*/
	...
	public static AssetStockGoodsAdjust createFrom(Map<String,Object> assetStockGoodsAdjustMap) {
		...
		AssetStockGoodsAdjust po = EntityContext.create(AssetStockGoodsAdjust.class, assetStockGoodsAdjustMap);
		return po;
	}
	...
	*/
	...
	public static AssetStockGoodsAdjust createFrom(Object pojo) {
		...
		AssetStockGoodsAdjust po = EntityContext.create(AssetStockGoodsAdjust.class,pojo);
		return po;
	}
	...
	*/
	...
	public static AssetStockGoodsAdjust create() {
		return EntityContext.create(AssetStockGoodsAdjust.class);
	}
}