...
public class ServiceCategoryVO extends ServiceCategory {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public ServiceCategoryVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public ServiceCategoryVO addId(String... id) {
