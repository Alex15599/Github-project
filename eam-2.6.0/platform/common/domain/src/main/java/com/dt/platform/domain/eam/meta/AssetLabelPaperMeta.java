...
public class AssetLabelPaperMeta {
	...
	*/
	 ...
	 * 长度 , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetLabelPaper,java.math.BigDecimal> W_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetLabelPaper.class ,W, java.math.BigDecimal.class, "长度", "长度", java.math.BigDecimal.class, null);
	...
	*/
	 ...
	 * 宽带 , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetLabelPaper,java.math.BigDecimal> H_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetLabelPaper.class ,H, java.math.BigDecimal.class, "宽带", "宽带", java.math.BigDecimal.class, null);
	...
	*/
	 ...
	 * 实现动作 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetLabelPaper,java.lang.String> ACTION_CODE_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetLabelPaper.class ,ACTION_CODE, java.lang.String.class, "实现动作", "实现动作", java.lang.String.class, null);
	...
	*/
	 ...
	 * 全部属性清单
	*/
	public static final String[] $PROPS={ ID , NAME , STATUS , W , H , ACTION_CODE , TYPE , COLUMN_NUMBER , SORT , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID };
