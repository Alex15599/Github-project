...
import com.dt.platform.constants.db.OpsTables.OPS_CERTIFICATE_TYPE;
...
@Table(name = "ops_certificate_type")
public class CertificateType extends Entity {

	private static final long serialVersionUID = 1L;

	public static final DBTable TABLE =OPS_CERTIFICATE_TYPE.$TABLE;
	...
	*/
	...
	public static CertificateType createFrom(Map<String,Object> certificateTypeMap) {
		...
		CertificateType po = EntityContext.create(CertificateType.class, certificateTypeMap);
		return po;
	}
	...
	*/
	...
	public static CertificateType createFrom(Object pojo) {
		...
		CertificateType po = EntityContext.create(CertificateType.class,pojo);
		return po;
	}
	...
	*/
	...
	public static CertificateType create() {
		return EntityContext.create(CertificateType.class);
	}
}