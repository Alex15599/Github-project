...
import com.dt.platform.constants.db.OpsTables.OPS_VOUCHER_OWNER;
...
public class VoucherOwner extends Entity {
	...
	*/
	@Transient
	public VoucherOwner setDeleted(Boolean deletedBool) {
		if(deletedBool==null) {
			this.deleted=null;
		} else {
	...
	*/
	public VoucherOwner addVoucherCategory(DictItem... entity) {
		...
		this.voucherCategory.addAll(Arrays.asList(entity));
		return this;
	}
