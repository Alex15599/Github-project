...
public class NetworkStrategyApplyVO extends NetworkStrategyApply {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public NetworkStrategyApplyVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public NetworkStrategyApplyVO addId(String... id) {
