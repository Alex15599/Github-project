...
public class AutoTaskNode extends Entity {
	...
	*/
	...
	public static AutoTaskNode createFrom(Map<String,Object> autoTaskNodeMap) {
		...
		AutoTaskNode po = EntityContext.create(AutoTaskNode.class, autoTaskNodeMap);
		return po;
	}
	...
	*/
	...
	public static AutoTaskNode createFrom(Object pojo) {
		...
		AutoTaskNode po = EntityContext.create(AutoTaskNode.class,pojo);
		return po;
	}
	...
	*/
	...
	public static AutoTaskNode create() {
		return EntityContext.create(AutoTaskNode.class);
	}
}