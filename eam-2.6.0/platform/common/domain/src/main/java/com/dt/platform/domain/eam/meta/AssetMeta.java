...
public class AssetMeta {
	...
	*/
	 ...
	 * 入账日期 , 类型: java.util.Date
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.Asset,java.util.Date> REGISTER_DATE_PROP = new BeanProperty(com.dt.platform.domain.eam.Asset.class ,REGISTER_DATE, java.util.Date.class, "入账日期", "入账日期", java.util.Date.class, null);
	...
	*/
	 ...
	 * 已用期限 , (月) , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.Asset,java.math.BigDecimal> ASSET_USED_SERVICE_LIFE_PROP = new BeanProperty(com.dt.platform.domain.eam.Asset.class ,ASSET_USED_SERVICE_LIFE, java.math.BigDecimal.class, "已用期限", "(月)", java.math.BigDecimal.class, null);
	...
	*/
	 ...
	 * 最后折旧 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.Asset,java.lang.String> DEPRECIATION_ID_PROP = new BeanProperty(com.dt.platform.domain.eam.Asset.class ,DEPRECIATION_ID, java.lang.String.class, "最后折旧", "最后折旧", java.lang.String.class, null);
	...
	*/
	 ...
	 * 折旧年份 , 类型: java.lang.Integer
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.Asset,java.lang.Integer> DEPRECIATION_YEAR_PROP = new BeanProperty(com.dt.platform.domain.eam.Asset.class ,DEPRECIATION_YEAR, java.lang.Integer.class, "折旧年份", "折旧年份", java.lang.Integer.class, null);
	...
	*/
	 ...
	 * 登记时间 , 类型: java.util.Date
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.Asset,java.util.Date> ENTRY_TIME_PROP = new BeanProperty(com.dt.platform.domain.eam.Asset.class ,ENTRY_TIME, java.util.Date.class, "登记时间", "登记时间", java.util.Date.class, null);
