...
/**
 * 资产转移VO类型
 * <p>资产转移 , 数据表 eam_asset_tranfer 的通用VO类型</p>
...
@ApiModel(description = "资产转移VO类型 ; 资产转移 , 数据表 eam_asset_tranfer 的通用VO类型" , parent = AssetTranfer.class)
public class AssetTranferVO extends AssetTranfer {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetTranferVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetTranferVO addId(String... id) {
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return AssetTranferVO , 转换好的 AssetTranferVO 对象
	*/
	@Transient
	 ...
	 * @return AssetTranferVO , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	...
	public AssetTranferVO duplicate(boolean all) {
		com.dt.platform.domain.eam.meta.AssetTranferVOMeta.$$proxy$$ inst = new com.dt.platform.domain.eam.meta.AssetTranferVOMeta.$$proxy$$();
	...
	*/
	@Transient
	public AssetTranferVO clone(boolean deep) {
		return EntityContext.clone(AssetTranferVO.class,this,deep);
	}

	/**
	 * 将 Map 转换成 AssetTranferVO
	 * @param assetTranferMap 包含实体信息的 Map 对象
	 * @return AssetTranferVO , 转换好的的 AssetTranfer 对象
	*/
	@Transient
	public static AssetTranferVO createFrom(Map<String,Object> assetTranferMap) {
		if(assetTranferMap==null) return null;
		AssetTranferVO vo = create();
		EntityContext.copyProperties(vo,assetTranferMap);
		vo.clearModifies();
		return vo;
	}

	/**
	 * 将 Pojo 转换成 AssetTranferVO
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return AssetTranferVO , 转换好的的 AssetTranfer 对象
	*/
	@Transient
	public static AssetTranferVO createFrom(Object pojo) {
	...
	/**
	 * 创建一个 AssetTranferVO，等同于 new
	 * @return AssetTranferVO 对象
	*/
	@Transient
	public static AssetTranferVO create() {
		return new com.dt.platform.domain.eam.meta.AssetTranferVOMeta.$$proxy$$();
	}
}