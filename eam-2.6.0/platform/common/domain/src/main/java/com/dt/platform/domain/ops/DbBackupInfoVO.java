...
public class DbBackupInfoVO extends DbBackupInfo {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public DbBackupInfoVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public DbBackupInfoVO addId(String... id) {
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return DbBackupInfoVO , 转换好的 DbBackupInfoVO 对象
	*/
	@Transient
	 ...
	 * @return DbBackupInfoVO , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	@Transient
	public DbBackupInfoVO clone(boolean deep) {
		return EntityContext.clone(DbBackupInfoVO.class,this,deep);
	}

	/**
	 * 将 Map 转换成 DbBackupInfoVO
	 * @param dbBackupInfoMap 包含实体信息的 Map 对象
	 * @return DbBackupInfoVO , 转换好的的 DbBackupInfo 对象
	*/
	@Transient
	public static DbBackupInfoVO createFrom(Map<String,Object> dbBackupInfoMap) {
		if(dbBackupInfoMap==null) return null;
		DbBackupInfoVO vo = create();
		EntityContext.copyProperties(vo,dbBackupInfoMap);
		vo.clearModifies();
		return vo;
	}

	/**
	 * 将 Pojo 转换成 DbBackupInfoVO
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return DbBackupInfoVO , 转换好的的 DbBackupInfo 对象
	*/
	@Transient
	public static DbBackupInfoVO createFrom(Object pojo) {
	...
	/**
	 * 创建一个 DbBackupInfoVO，等同于 new
	 * @return DbBackupInfoVO 对象
	*/
	@Transient
