...
public class AutoGroup extends Entity {
	...
	public static final DBTable TABLE =OPS_AUTO_GROUP.$TABLE;
	...
	*/
	@Transient
	public AutoGroup setDeleted(Boolean deletedBool) {
		if(deletedBool==null) {
			this.deleted=null;
		} else {
	...
	*/
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return AutoGroup , 转换好的 AutoGroup 对象
	*/
	@Transient
