...
@ApiModel(description = "配置值VO类型 ; 配置值 , 数据表 ops_cmdb_model_v 的通用VO类型" , parent = CmdbModelV.class)
public class CmdbModelVVO extends CmdbModelV {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public CmdbModelVVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public CmdbModelVVO addId(String... id) {
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return CmdbModelVVO , 转换好的 CmdbModelVVO 对象
	*/
	@Transient
	 ...
	 * @return CmdbModelVVO , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	...
	public CmdbModelVVO duplicate(boolean all) {
		com.dt.platform.domain.ops.meta.CmdbModelVVOMeta.$$proxy$$ inst = new com.dt.platform.domain.ops.meta.CmdbModelVVOMeta.$$proxy$$();
	...
	*/
	@Transient
	public CmdbModelVVO clone(boolean deep) {
		return EntityContext.clone(CmdbModelVVO.class,this,deep);
	}

	/**
	 * 将 Map 转换成 CmdbModelVVO
	 * @param cmdbModelVMap 包含实体信息的 Map 对象
	 * @return CmdbModelVVO , 转换好的的 CmdbModelV 对象
	*/
	@Transient
	public static CmdbModelVVO createFrom(Map<String,Object> cmdbModelVMap) {
		if(cmdbModelVMap==null) return null;
		CmdbModelVVO vo = create();
		EntityContext.copyProperties(vo,cmdbModelVMap);
		vo.clearModifies();
		return vo;
	}

	/**
	 * 将 Pojo 转换成 CmdbModelVVO
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return CmdbModelVVO , 转换好的的 CmdbModelV 对象
	*/
	@Transient
	public static CmdbModelVVO createFrom(Object pojo) {
	...
	/**
	 * 创建一个 CmdbModelVVO，等同于 new
	 * @return CmdbModelVVO 对象
	*/
	@Transient
	public static CmdbModelVVO create() {
		return new com.dt.platform.domain.ops.meta.CmdbModelVVOMeta.$$proxy$$();
	}
}