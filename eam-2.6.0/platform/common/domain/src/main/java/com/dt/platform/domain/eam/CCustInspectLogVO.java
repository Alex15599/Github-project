...
@ApiModel(description = "执行日志VO类型 ; 执行日志 , 数据表 eam_c_cust_inspect_log 的通用VO类型" , parent = CCustInspectLog.class)
public class CCustInspectLogVO extends CCustInspectLog {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public CCustInspectLogVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public CCustInspectLogVO addId(String... id) {
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return CCustInspectLogVO , 转换好的 CCustInspectLogVO 对象
	*/
	@Transient
	 ...
	 * @return CCustInspectLogVO , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	@Transient
	public CCustInspectLogVO clone(boolean deep) {
		return EntityContext.clone(CCustInspectLogVO.class,this,deep);
	}

	/**
	 * 将 Map 转换成 CCustInspectLogVO
	 * @param cCustInspectLogMap 包含实体信息的 Map 对象
	 * @return CCustInspectLogVO , 转换好的的 CCustInspectLog 对象
	*/
	@Transient
	public static CCustInspectLogVO createFrom(Map<String,Object> cCustInspectLogMap) {
		if(cCustInspectLogMap==null) return null;
		CCustInspectLogVO vo = create();
		EntityContext.copyProperties(vo,cCustInspectLogMap);
		vo.clearModifies();
		return vo;
	}

	/**
	 * 将 Pojo 转换成 CCustInspectLogVO
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return CCustInspectLogVO , 转换好的的 CCustInspectLog 对象
	*/
	@Transient
	public static CCustInspectLogVO createFrom(Object pojo) {
	...
	/**
	 * 创建一个 CCustInspectLogVO，等同于 new
	 * @return CCustInspectLogVO 对象
	*/
	@Transient
	public static CCustInspectLogVO create() {
		return new com.dt.platform.domain.eam.meta.CCustInspectLogVOMeta.$$proxy$$();
	}
	...
	*/
	public boolean read(Map<String, Object> map,boolean cast) {
		...
		if(cast) {
			...
			this.setSortType(DataParser.parse(String.class, map.get(CCustInspectLogVOMeta.SORT_TYPE)));
			this.setRequestAction(DataParser.parse(String.class, map.get(CCustInspectLogVOMeta.REQUEST_ACTION)));
			this.setFuzzyField(DataParser.parse(String.class, map.get(CCustInspectLogVOMeta.FUZZY_FIELD)));
			this.setSortField(DataParser.parse(String.class, map.get(CCustInspectLogVOMeta.SORT_FIELD)));
			this.setPageSize(DataParser.parse(Integer.class, map.get(CCustInspectLogVOMeta.PAGE_SIZE)));
			this.setDataOrigin(DataParser.parse(String.class, map.get(CCustInspectLogVOMeta.DATA_ORIGIN)));
			this.setQueryLogic(DataParser.parse(String.class, map.get(CCustInspectLogVOMeta.QUERY_LOGIC)));
			this.setSearchValue(DataParser.parse(String.class, map.get(CCustInspectLogVOMeta.SEARCH_VALUE)));
			return true;
		} else {
			try {
				...
				this.setSortType( (String)map.get(CCustInspectLogVOMeta.SORT_TYPE));
				this.setRequestAction( (String)map.get(CCustInspectLogVOMeta.REQUEST_ACTION));
				this.setFuzzyField( (String)map.get(CCustInspectLogVOMeta.FUZZY_FIELD));
				this.setSortField( (String)map.get(CCustInspectLogVOMeta.SORT_FIELD));
				this.setPageSize( (Integer)map.get(CCustInspectLogVOMeta.PAGE_SIZE));
				this.setDataOrigin( (String)map.get(CCustInspectLogVOMeta.DATA_ORIGIN));
				this.setQueryLogic( (String)map.get(CCustInspectLogVOMeta.QUERY_LOGIC));
				this.setSearchValue( (String)map.get(CCustInspectLogVOMeta.SEARCH_VALUE));
				return true;
			} catch (Exception e) {
				return false;
			}
