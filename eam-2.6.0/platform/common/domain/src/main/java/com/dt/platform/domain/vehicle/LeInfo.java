...
public class LeInfo extends Entity {
	...
	*/
	@Transient
	public LeInfo setDeleted(Boolean deletedBool) {
		if(deletedBool==null) {
			this.deleted=null;
		} else {
	...
	*/
	@Transient
	public LeInfo clone() {
		return EntityContext.clone(LeInfo.class,this);
	}
	...
	*/
	@Transient
	public LeInfo clone(boolean deep) {
		return EntityContext.clone(LeInfo.class,this,deep);
	}

	/**
	 * 将 Map 转换成 LeInfo
	 * @param leInfoMap 包含实体信息的 Map 对象
	 * @return LeInfo , 转换好的的 LeInfo 对象
	*/
	@Transient
	public static LeInfo createFrom(Map<String,Object> leInfoMap) {
		if(leInfoMap==null) return null;
		LeInfo po = EntityContext.create(LeInfo.class, leInfoMap);
		return po;
	}
	...
	*/
	@Transient
	public static LeInfo createFrom(Object pojo) {
		if(pojo==null) return null;
		LeInfo po = EntityContext.create(LeInfo.class,pojo);
		return po;
	}
	...
	*/
	@Transient
	public static LeInfo create() {
		return EntityContext.create(LeInfo.class);
	}
}