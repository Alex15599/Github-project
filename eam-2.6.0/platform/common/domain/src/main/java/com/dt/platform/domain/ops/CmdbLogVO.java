...
/**
 * 配置日志VO类型
 * <p>配置日志 , 数据表 ops_cmdb_log 的通用VO类型</p>
...
@ApiModel(description = "配置日志VO类型 ; 配置日志 , 数据表 ops_cmdb_log 的通用VO类型" , parent = CmdbLog.class)
public class CmdbLogVO extends CmdbLog {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public CmdbLogVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public CmdbLogVO addId(String... id) {
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return CmdbLogVO , 转换好的 CmdbLogVO 对象
	*/
	@Transient
	...
	*/
	...
	public CmdbLogVO duplicate(boolean all) {
		com.dt.platform.domain.ops.meta.CmdbLogVOMeta.$$proxy$$ inst = new com.dt.platform.domain.ops.meta.CmdbLogVOMeta.$$proxy$$();
	...
	*/
	@Transient
	public CmdbLogVO clone(boolean deep) {
		return EntityContext.clone(CmdbLogVO.class,this,deep);
	}

	/**
	 * 将 Map 转换成 CmdbLogVO
	 * @param cmdbLogMap 包含实体信息的 Map 对象
	 * @return CmdbLogVO , 转换好的的 CmdbLog 对象
	*/
	@Transient
	public static CmdbLogVO createFrom(Map<String,Object> cmdbLogMap) {
		if(cmdbLogMap==null) return null;
		CmdbLogVO vo = create();
		EntityContext.copyProperties(vo,cmdbLogMap);
		vo.clearModifies();
		return vo;
	}

	/**
	 * 将 Pojo 转换成 CmdbLogVO
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return CmdbLogVO , 转换好的的 CmdbLog 对象
	*/
	@Transient
	public static CmdbLogVO createFrom(Object pojo) {
	...
	/**
	 * 创建一个 CmdbLogVO，等同于 new
	 * @return CmdbLogVO 对象
	*/
	@Transient
	public static CmdbLogVO create() {
		return new com.dt.platform.domain.ops.meta.CmdbLogVOMeta.$$proxy$$();
	}
}