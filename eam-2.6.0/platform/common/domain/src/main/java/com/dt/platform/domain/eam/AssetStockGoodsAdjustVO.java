...
public class AssetStockGoodsAdjustVO extends AssetStockGoodsAdjust {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetStockGoodsAdjustVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetStockGoodsAdjustVO addId(String... id) {
