...
public class MaintainTaskProjectVOMeta extends MaintainTaskProjectMeta {
	...
	*/
	 ...
	 * 数据来源 , 前端指定不同的来源，后端可按来源执行不同的逻辑 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.MaintainTaskProjectVO,java.lang.String> DATA_ORIGIN_PROP = new BeanProperty(com.dt.platform.domain.eam.MaintainTaskProjectVO.class ,DATA_ORIGIN, java.lang.String.class, "数据来源", "前端指定不同的来源，后端可按来源执行不同的逻辑", java.lang.String.class, null);
	...
	*/
	 ...
	 * 查询逻辑 , 默认and，可指定 or  , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.MaintainTaskProjectVO,java.lang.String> QUERY_LOGIC_PROP = new BeanProperty(com.dt.platform.domain.eam.MaintainTaskProjectVO.class ,QUERY_LOGIC, java.lang.String.class, "查询逻辑", "默认and，可指定 or ", java.lang.String.class, null);
	...
	*/
	 ...
	 * 请求动作 , 前端指定不同的Action，后端可Action执行不同的逻辑 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.MaintainTaskProjectVO,java.lang.String> REQUEST_ACTION_PROP = new BeanProperty(com.dt.platform.domain.eam.MaintainTaskProjectVO.class ,REQUEST_ACTION, java.lang.String.class, "请求动作", "前端指定不同的Action，后端可Action执行不同的逻辑", java.lang.String.class, null);
	...
	*/
	 ...
	 * 保养结果 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.MaintainTaskProjectVO,java.lang.String> CONTENT_PROP = new BeanProperty(com.dt.platform.domain.eam.MaintainTaskProjectVO.class ,CONTENT, java.lang.String.class, "保养结果", "保养结果", java.lang.String.class, null);
	...
	*/
	 ...
	 * 标准工时 , 小时) , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.MaintainTaskProjectVO,java.math.BigDecimal> PROJECT_BASE_COST_PROP = new BeanProperty(com.dt.platform.domain.eam.MaintainTaskProjectVO.class ,PROJECT_BASE_COST, java.math.BigDecimal.class, "标准工时", "小时)", java.math.BigDecimal.class, null);
	...
	*/
	 ...
	 * 标准工时 , 小时) , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.MaintainTaskProjectVO,java.math.BigDecimal> BASE_COST_PROP = new BeanProperty(com.dt.platform.domain.eam.MaintainTaskProjectVO.class ,BASE_COST, java.math.BigDecimal.class, "标准工时", "小时)", java.math.BigDecimal.class, null);
