...
public class MonitorObjectModelVO extends MonitorObjectModel {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public MonitorObjectModelVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public MonitorObjectModelVO addId(String... id) {
