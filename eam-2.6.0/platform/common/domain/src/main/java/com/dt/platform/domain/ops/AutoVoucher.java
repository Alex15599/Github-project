...
public class AutoVoucher extends Entity {
	...
	*/
	...
	public static AutoVoucher createFrom(Map<String,Object> autoVoucherMap) {
		...
		AutoVoucher po = EntityContext.create(AutoVoucher.class, autoVoucherMap);
		return po;
	}
	...
	*/
	...
	public static AutoVoucher createFrom(Object pojo) {
		...
		AutoVoucher po = EntityContext.create(AutoVoucher.class,pojo);
		return po;
	}
	...
	*/
	...
	public static AutoVoucher create() {
		return EntityContext.create(AutoVoucher.class);
	}
}