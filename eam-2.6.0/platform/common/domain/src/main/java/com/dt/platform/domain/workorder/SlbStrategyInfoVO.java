...
public class SlbStrategyInfoVO extends SlbStrategyInfo {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public SlbStrategyInfoVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public SlbStrategyInfoVO addId(String... id) {
