...
public class AutoActionFile extends Entity {
	...
	*/
	...
	public static AutoActionFile createFrom(Map<String,Object> autoActionFileMap) {
		...
		AutoActionFile po = EntityContext.create(AutoActionFile.class, autoActionFileMap);
		return po;
	}
	...
	*/
	...
	public static AutoActionFile createFrom(Object pojo) {
		...
		AutoActionFile po = EntityContext.create(AutoActionFile.class,pojo);
		return po;
	}
	...
	*/
	...
	public static AutoActionFile create() {
		return EntityContext.create(AutoActionFile.class);
	}
}