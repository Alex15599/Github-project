...
public class NetworkStrategyInfoVO extends NetworkStrategyInfo {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public NetworkStrategyInfoVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public NetworkStrategyInfoVO addId(String... id) {
