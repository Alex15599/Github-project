...
public class CiphertextBoxDataVO extends CiphertextBoxData {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public CiphertextBoxDataVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public CiphertextBoxDataVO addId(String... id) {
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return CiphertextBoxDataVO , 转换好的 CiphertextBoxDataVO 对象
	*/
	@Transient
	 ...
	 * @return CiphertextBoxDataVO , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	...
	public CiphertextBoxDataVO duplicate(boolean all) {
		com.dt.platform.domain.ops.meta.CiphertextBoxDataVOMeta.$$proxy$$ inst = new com.dt.platform.domain.ops.meta.CiphertextBoxDataVOMeta.$$proxy$$();
	...
	*/
	@Transient
	public CiphertextBoxDataVO clone(boolean deep) {
		return EntityContext.clone(CiphertextBoxDataVO.class,this,deep);
	}

	/**
	 * 将 Map 转换成 CiphertextBoxDataVO
	 * @param ciphertextBoxDataMap 包含实体信息的 Map 对象
	 * @return CiphertextBoxDataVO , 转换好的的 CiphertextBoxData 对象
	*/
	@Transient
	public static CiphertextBoxDataVO createFrom(Map<String,Object> ciphertextBoxDataMap) {
		if(ciphertextBoxDataMap==null) return null;
		CiphertextBoxDataVO vo = create();
		EntityContext.copyProperties(vo,ciphertextBoxDataMap);
		vo.clearModifies();
		return vo;
	}

	/**
	 * 将 Pojo 转换成 CiphertextBoxDataVO
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return CiphertextBoxDataVO , 转换好的的 CiphertextBoxData 对象
	*/
	@Transient
	public static CiphertextBoxDataVO createFrom(Object pojo) {
	...
	/**
	 * 创建一个 CiphertextBoxDataVO，等同于 new
	 * @return CiphertextBoxDataVO 对象
	*/
	@Transient
	public static CiphertextBoxDataVO create() {
		return new com.dt.platform.domain.ops.meta.CiphertextBoxDataVOMeta.$$proxy$$();
	}
}