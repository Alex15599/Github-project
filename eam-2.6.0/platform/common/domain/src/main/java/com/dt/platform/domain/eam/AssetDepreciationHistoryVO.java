...
public class AssetDepreciationHistoryVO extends AssetDepreciationHistory {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetDepreciationHistoryVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssetDepreciationHistoryVO addId(String... id) {
