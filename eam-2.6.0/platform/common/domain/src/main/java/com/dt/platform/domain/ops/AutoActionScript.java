...
public class AutoActionScript extends Entity {
	...
	*/
	...
	public static AutoActionScript createFrom(Map<String,Object> autoActionScriptMap) {
		...
		AutoActionScript po = EntityContext.create(AutoActionScript.class, autoActionScriptMap);
		return po;
	}
	...
	*/
	...
	public static AutoActionScript createFrom(Object pojo) {
		...
		AutoActionScript po = EntityContext.create(AutoActionScript.class,pojo);
		return po;
	}
	...
	*/
	...
	public static AutoActionScript create() {
		return EntityContext.create(AutoActionScript.class);
	}
}