...
public class VehicleInfoGtr extends BaseCodeGenerator {
    ...
    public void generateCode() throws Exception {
        ...
        cfg.view().field(VehicleTables.VEHICLE_INFO.VEHICLE_CODE).search().fuzzySearch();
        ...
        cfg.view().field(VehicleTables.VEHICLE_INFO.NOTES).table().disable();
        cfg.view().field(VehicleTables.VEHICLE_INFO.TECHNICAL_PARAMETER).table().disable();

        cfg.view().search().inputLayout(
                new Object[]{
                        VehicleTables.VEHICLE_INFO.VEHICLE_STATUS,
                        VehicleTables.VEHICLE_INFO.TYPE,
                        VehicleTables.VEHICLE_INFO.VEHICLE_CODE,
        ...
        cfg.view().field(VehicleTables.VEHICLE_INFO.VEHICLE_CODE).form().validate().required();
