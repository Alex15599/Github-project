...
public class BaseCodeGenerator {
    ...
    public static final String BASIC_MGR_MENU_ID="682489603705274368";
    public static final String BASIC_SETTING_MENU_ID="562319582266654720";



    //
    private String appId="service-wms";

    private String appConfigPrefix= "service-wms";

    private String tablePrefix="wms_";
