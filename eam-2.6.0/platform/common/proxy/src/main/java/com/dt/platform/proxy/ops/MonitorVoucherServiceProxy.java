...
public interface MonitorVoucherServiceProxy {
    ...
    Result insert(@RequestParam(name = "monitorVoucherVO") MonitorVoucherVO monitorVoucherVO);
    ...
    Result update(@RequestParam(name = "monitorVoucherVO") MonitorVoucherVO monitorVoucherVO);

    /**
     * 更新监控凭证
     */
    @RequestMapping(MonitorVoucherServiceProxy.SAVE)
    Result save(@RequestParam(name = "monitorVoucherVO") MonitorVoucherVO monitorVoucherVO);

    /**
     * 获取监控凭证
     */
    @RequestMapping(MonitorVoucherServiceProxy.GET_BY_ID)
    Result<MonitorVoucher> getById(@RequestParam(name = "id") String id);

    /**
     * 获取多个监控凭证
     */
    @RequestMapping(MonitorVoucherServiceProxy.GET_BY_IDS)
    Result<List<MonitorVoucher>> getByIds(@RequestParam(name = "ids") List<String> ids);

    /**
     * 查询监控凭证
     */
    @RequestMapping(MonitorVoucherServiceProxy.QUERY_LIST)
    Result<List<MonitorVoucher>> queryList(@RequestParam(name = "sample") MonitorVoucherVO sample);

    /**
     * 分页查询监控凭证
     */
    @RequestMapping(MonitorVoucherServiceProxy.QUERY_PAGED_LIST)
    Result<PagedList<MonitorVoucher>> queryPagedList(@RequestParam(name = "sample") MonitorVoucherVO sample);
