...
public interface MonitorNodeGroupServiceProxy {
    ...
    Result insert(@RequestParam(name = "monitorNodeGroupVO") MonitorNodeGroupVO monitorNodeGroupVO);
    ...
    Result update(@RequestParam(name = "monitorNodeGroupVO") MonitorNodeGroupVO monitorNodeGroupVO);

    /**
     * 更新节点分组
     */
    @RequestMapping(MonitorNodeGroupServiceProxy.SAVE)
    Result save(@RequestParam(name = "monitorNodeGroupVO") MonitorNodeGroupVO monitorNodeGroupVO);

    /**
     * 获取节点分组
     */
    @RequestMapping(MonitorNodeGroupServiceProxy.GET_BY_ID)
    Result<MonitorNodeGroup> getById(@RequestParam(name = "id") String id);

    /**
     * 获取多个节点分组
     */
    @RequestMapping(MonitorNodeGroupServiceProxy.GET_BY_IDS)
    Result<List<MonitorNodeGroup>> getByIds(@RequestParam(name = "ids") List<String> ids);

    /**
     * 查询节点分组
     */
    @RequestMapping(MonitorNodeGroupServiceProxy.QUERY_LIST)
    Result<List<MonitorNodeGroup>> queryList(@RequestParam(name = "sample") MonitorNodeGroupVO sample);

    /**
     * 分页查询节点分组
     */
    @RequestMapping(MonitorNodeGroupServiceProxy.QUERY_PAGED_LIST)
    Result<PagedList<MonitorNodeGroup>> queryPagedList(@RequestParam(name = "sample") MonitorNodeGroupVO sample);
