...
public interface AssetItemServiceProxy {
    ...
    Result insert(@RequestParam(name = "assetItemVO") AssetItemVO assetItemVO);
    ...
    Result update(@RequestParam(name = "assetItemVO") AssetItemVO assetItemVO);

    /**
     * 更新资产
     */
    @RequestMapping(AssetItemServiceProxy.SAVE)
    Result save(@RequestParam(name = "assetItemVO") AssetItemVO assetItemVO);
    ...
    Result<List<AssetItem>> queryList(@RequestParam(name = "sample") AssetItemVO sample);

    /**
     * 分页查询资产
     */
    @RequestMapping(AssetItemServiceProxy.QUERY_PAGED_LIST)
    Result<PagedList<AssetItem>> queryPagedList(@RequestParam(name = "sample") AssetItemVO sample);
