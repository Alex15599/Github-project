...
public interface AssetStockCollectionServiceProxy {
    ...
    Result insert(@RequestParam(name = "assetStockCollectionVO") AssetStockCollectionVO assetStockCollectionVO);
    ...
    Result update(@RequestParam(name = "assetStockCollectionVO") AssetStockCollectionVO assetStockCollectionVO);

    /**
     * 更新资产领用
     */
    @RequestMapping(AssetStockCollectionServiceProxy.SAVE)
    Result save(@RequestParam(name = "assetStockCollectionVO") AssetStockCollectionVO assetStockCollectionVO);

    /**
     * 获取资产领用
     */
    @RequestMapping(AssetStockCollectionServiceProxy.GET_BY_ID)
    Result<AssetStockCollection> getById(@RequestParam(name = "id") String id);

    /**
     * 批量删除资产领用
     */
    @RequestMapping(AssetStockCollectionServiceProxy.GET_BY_IDS)
    Result<List<AssetStockCollection>> getByIds(@RequestParam(name = "ids") List<String> ids);

    /**
     * 查询资产领用
     */
    @RequestMapping(AssetStockCollectionServiceProxy.QUERY_LIST)
    Result<List<AssetStockCollection>> queryList(@RequestParam(name = "sample") AssetStockCollectionVO sample);

    /**
     * 分页查询资产领用
     */
    @RequestMapping(AssetStockCollectionServiceProxy.QUERY_PAGED_LIST)
    Result<PagedList<AssetStockCollection>> queryPagedList(@RequestParam(name = "sample") AssetStockCollectionVO sample);
