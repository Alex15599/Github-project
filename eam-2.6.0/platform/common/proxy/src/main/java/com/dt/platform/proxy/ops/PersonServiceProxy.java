 ...
 */
@FeignClient(value = ServiceNames.OPS, contextId = PersonServiceProxy.API_CONTEXT_PATH, configuration = FeignConfiguration.class)
public interface PersonServiceProxy {
    ...
    /**
     * API 上下文路径 , ops-person
     */
    public static final String API_CONTEXT_PATH = "ops-person";
     ...
     * 控制器类名
     */
    public static final String CONTROLLER_CLASS_NAME = "com.dt.platform.ops.controller.PersonController";
