...
public interface CertificateServiceProxy {
    ...
    /**
     * API 上下文路径 , hr-certificate
     */
    public static final String API_CONTEXT_PATH = "hr-certificate";
     ...
     * 控制器类名
     */
    public static final String CONTROLLER_CLASS_NAME = "com.dt.platform.hr.controller.CertificateController";
