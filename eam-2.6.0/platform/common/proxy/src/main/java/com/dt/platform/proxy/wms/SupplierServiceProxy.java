 ...
 */
@FeignClient(value = ServiceNames.WMS, contextId = SupplierServiceProxy.API_CONTEXT_PATH, configuration = FeignConfiguration.class)
public interface SupplierServiceProxy {
    ...
    /**
     * API 上下文路径 , wms-supplier
     */
    public static final String API_CONTEXT_PATH = "wms-supplier";
     ...
     * 控制器类名
     */
    public static final String CONTROLLER_CLASS_NAME = "com.dt.platform.wms.controller.SupplierController";
