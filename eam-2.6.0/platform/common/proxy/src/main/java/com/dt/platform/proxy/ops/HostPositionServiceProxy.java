...
public interface HostPositionServiceProxy {
    ...
    Result insert(@RequestParam(name = "hostPositionVO") HostPositionVO hostPositionVO);
    ...
    Result update(@RequestParam(name = "hostPositionVO") HostPositionVO hostPositionVO);

    /**
     * 更新主机位置
     */
    @RequestMapping(HostPositionServiceProxy.SAVE)
    Result save(@RequestParam(name = "hostPositionVO") HostPositionVO hostPositionVO);
    ...
    Result<List<HostPosition>> queryList(@RequestParam(name = "sample") HostPositionVO sample);

    /**
     * 分页查询主机位置
     */
    @RequestMapping(HostPositionServiceProxy.QUERY_PAGED_LIST)
    Result<PagedList<HostPosition>> queryPagedList(@RequestParam(name = "sample") HostPositionVO sample);
