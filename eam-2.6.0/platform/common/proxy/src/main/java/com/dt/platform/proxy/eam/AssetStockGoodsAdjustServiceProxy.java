...
public interface AssetStockGoodsAdjustServiceProxy {
    ...
    Result insert(@RequestParam(name = "assetStockGoodsAdjustVO") AssetStockGoodsAdjustVO assetStockGoodsAdjustVO);
    ...
    Result update(@RequestParam(name = "assetStockGoodsAdjustVO") AssetStockGoodsAdjustVO assetStockGoodsAdjustVO);

    /**
     * 更新库存调整
     */
    @RequestMapping(AssetStockGoodsAdjustServiceProxy.SAVE)
    Result save(@RequestParam(name = "assetStockGoodsAdjustVO") AssetStockGoodsAdjustVO assetStockGoodsAdjustVO);

    /**
     * 获取库存调整
     */
    @RequestMapping(AssetStockGoodsAdjustServiceProxy.GET_BY_ID)
    Result<AssetStockGoodsAdjust> getById(@RequestParam(name = "id") String id);

    /**
     * 获取多个库存调整
     */
    @RequestMapping(AssetStockGoodsAdjustServiceProxy.GET_BY_IDS)
    Result<List<AssetStockGoodsAdjust>> getByIds(@RequestParam(name = "ids") List<String> ids);

    /**
     * 查询库存调整
     */
    @RequestMapping(AssetStockGoodsAdjustServiceProxy.QUERY_LIST)
    Result<List<AssetStockGoodsAdjust>> queryList(@RequestParam(name = "sample") AssetStockGoodsAdjustVO sample);

    /**
     * 分页查询库存调整
     */
    @RequestMapping(AssetStockGoodsAdjustServiceProxy.QUERY_PAGED_LIST)
    Result<PagedList<AssetStockGoodsAdjust>> queryPagedList(@RequestParam(name = "sample") AssetStockGoodsAdjustVO sample);
