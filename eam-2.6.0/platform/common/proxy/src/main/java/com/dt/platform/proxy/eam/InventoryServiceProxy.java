...
public interface InventoryServiceProxy {
    ...
    Result insert(@RequestParam(name = "inventoryVO") InventoryVO inventoryVO);
    ...
    Result update(@RequestParam(name = "inventoryVO") InventoryVO inventoryVO);

    /**
     * 更新资产盘点
     */
    @RequestMapping(InventoryServiceProxy.SAVE)
    Result save(@RequestParam(name = "inventoryVO") InventoryVO inventoryVO);

    /**
     * 获取资产盘点
     */
    @RequestMapping(InventoryServiceProxy.GET_BY_ID)
    Result<Inventory> getById(@RequestParam(name = "id") String id);

    /**
     * 批量删除资产盘点
     */
    @RequestMapping(InventoryServiceProxy.GET_BY_IDS)
    Result<List<Inventory>> getByIds(@RequestParam(name = "ids") List<String> ids);

    /**
     * 查询资产盘点
     */
    @RequestMapping(InventoryServiceProxy.QUERY_LIST)
    Result<List<Inventory>> queryList(@RequestParam(name = "sample") InventoryVO sample);

    /**
     * 分页查询资产盘点
     */
    @RequestMapping(InventoryServiceProxy.QUERY_PAGED_LIST)
    Result<PagedList<Inventory>> queryPagedList(@RequestParam(name = "sample") InventoryVO sample);
