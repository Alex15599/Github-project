...
public interface WarehouseServiceProxy {
    ...
    Result insert(@RequestParam(name = "warehouseVO") WarehouseVO warehouseVO);
    ...
    Result update(@RequestParam(name = "warehouseVO") WarehouseVO warehouseVO);

    /**
     * 更新仓库
     */
    @RequestMapping(WarehouseServiceProxy.SAVE)
    Result save(@RequestParam(name = "warehouseVO") WarehouseVO warehouseVO);
    ...
    Result<List<Warehouse>> queryList(@RequestParam(name = "sample") WarehouseVO sample);

    /**
     * 分页查询仓库
     */
    @RequestMapping(WarehouseServiceProxy.QUERY_PAGED_LIST)
    Result<PagedList<Warehouse>> queryPagedList(@RequestParam(name = "sample") WarehouseVO sample);
