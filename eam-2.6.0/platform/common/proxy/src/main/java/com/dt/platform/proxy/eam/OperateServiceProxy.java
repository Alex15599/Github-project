...
public interface OperateServiceProxy {
    ...
    public Result approvalRequired(@RequestParam(name = "businessType") String businessType);

    /**
     * 添加资产操作
     */
    @RequestMapping(OperateServiceProxy.INSERT)
    Result insert(@RequestParam(name = "operateVO") OperateVO operateVO);
    ...
    Result update(@RequestParam(name = "operateVO") OperateVO operateVO);

    /**
     * 更新资产操作
     */
    @RequestMapping(OperateServiceProxy.SAVE)
    Result save(@RequestParam(name = "operateVO") OperateVO operateVO);

    /**
     * 获取资产操作
     */
    @RequestMapping(OperateServiceProxy.GET_BY_ID)
    Result<Operate> getById(@RequestParam(name = "id") String id);

    /**
     * 批量删除资产操作
     */
    @RequestMapping(OperateServiceProxy.GET_BY_IDS)
    Result<List<Operate>> getByIds(@RequestParam(name = "ids") List<String> ids);

    /**
     * 查询资产操作
     */
    @RequestMapping(OperateServiceProxy.QUERY_LIST)
    Result<List<Operate>> queryList(@RequestParam(name = "sample") OperateVO sample);

    /**
     * 分页查询资产操作
     */
    @RequestMapping(OperateServiceProxy.QUERY_PAGED_LIST)
    Result<PagedList<Operate>> queryPagedList(@RequestParam(name = "sample") OperateVO sample);
